...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.java.JdbcProvider}. This doesn't
...
public interface JdbcProviderValidator {
	...
	boolean validateImplementationClassName(String value);

	boolean validateNativepath(String value);

	boolean validateProviderName(String value);

	boolean validateProviderType(String value);
}
