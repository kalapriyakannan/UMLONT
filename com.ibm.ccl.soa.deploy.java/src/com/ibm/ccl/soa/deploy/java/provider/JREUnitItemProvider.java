...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.java.JREUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class JREUnitItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public JREUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JREUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JREUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JREUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JREUnit_type") : //$NON-NLS-1$
			getString("_UI_JREUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
