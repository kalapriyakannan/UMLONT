...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.java.JdbcProviderUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class JdbcProviderUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JdbcProviderUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JdbcProviderUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JdbcProviderUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JdbcProviderUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JdbcProviderUnit_type") : //$NON-NLS-1$
			getString("_UI_JdbcProviderUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
