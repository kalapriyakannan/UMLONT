...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.java.JRE}. This doesn't really do
...
public interface JREValidator {
	...
	boolean validateJreEdition(JREEdition value);

	boolean validateJreVersion(JREVersion value);

	boolean validateOtherValue(String value);
}
