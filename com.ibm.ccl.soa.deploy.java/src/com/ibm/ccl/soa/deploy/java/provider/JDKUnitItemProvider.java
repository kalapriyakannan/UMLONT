...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.java.JDKUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class JDKUnitItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public JDKUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JDKUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JDKUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JDKUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JDKUnit_type") : //$NON-NLS-1$
			getString("_UI_JDKUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
