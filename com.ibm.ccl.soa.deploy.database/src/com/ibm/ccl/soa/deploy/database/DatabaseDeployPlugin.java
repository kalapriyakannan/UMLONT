 ...
 */
public final class DatabaseDeployPlugin extends Plugin {
	public final static String pluginID = "com.ibm.ccl.soa.deploy.db2"; //$NON-NLS-1$

	//The shared instance.
	private static DatabaseDeployPlugin plugin;

	/**
	 * Default constructor.
	 */
	public DatabaseDeployPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static DatabaseDeployPlugin getDefault() {
		return plugin;
	}
