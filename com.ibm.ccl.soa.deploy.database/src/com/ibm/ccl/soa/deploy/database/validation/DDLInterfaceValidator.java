...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.database.DDLInterface}. This
 ...
 */
public interface DDLInterfaceValidator {
	boolean validate();

	boolean validateSchemaUri(String value);
}
