...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.database.DatabaseComponent} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DatabaseComponentItemProvider extends SoftwareComponentItemProvider implements
	 ...
	 * @generated
	 */
	public DatabaseComponentItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DatabaseComponent.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DatabaseComponent")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DatabaseComponent) object).getDisplayName();
		label = (label == null || label.length() == 0) ? ((DatabaseComponent) object).getName()
				: label;
		return label == null || label.length() == 0 ? getString("_UI_DatabaseComponent_type") : //$NON-NLS-1$
				label;
	}
