...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.database.DatabaseUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DatabaseUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public DatabaseUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DatabaseUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DatabaseUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DatabaseUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DatabaseUnit_type") : //$NON-NLS-1$
			getString("_UI_DatabaseUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
