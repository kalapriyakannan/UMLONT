...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.database.SQLModule} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class SQLModuleItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public SQLModuleItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SQLModule.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SQLModule")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SQLModule)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SQLModule_type") : //$NON-NLS-1$
			getString("_UI_SQLModule_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
