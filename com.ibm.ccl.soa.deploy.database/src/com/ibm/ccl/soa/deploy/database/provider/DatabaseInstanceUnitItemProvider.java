...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.database.DatabaseInstanceUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class DatabaseInstanceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public DatabaseInstanceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DatabaseInstanceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DatabaseInstanceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DatabaseInstanceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DatabaseInstanceUnit_type") : //$NON-NLS-1$
			getString("_UI_DatabaseInstanceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
