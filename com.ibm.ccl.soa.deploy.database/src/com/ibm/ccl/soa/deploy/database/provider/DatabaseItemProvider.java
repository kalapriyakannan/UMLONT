...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.database.Database} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DatabaseItemProvider extends CapabilityItemProvider implements
...
//		return overlayImage(object, getResourceLocator().getImage("full/obj16/Database")); //$NON-NLS-1$
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Database_type") : //$NON-NLS-1$
