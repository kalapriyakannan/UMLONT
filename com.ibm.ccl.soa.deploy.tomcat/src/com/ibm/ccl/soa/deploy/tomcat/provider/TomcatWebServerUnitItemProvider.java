...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.tomcat.TomcatWebServerUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class TomcatWebServerUnitItemProvider extends J2EEServerUnitItemProvider implements
	 ...
	 * @generated
	 */
	public TomcatWebServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TomcatWebServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TomcatWebServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TomcatWebServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TomcatWebServerUnit_type") : //$NON-NLS-1$
			getString("_UI_TomcatWebServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
