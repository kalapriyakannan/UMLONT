...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.tomcat.TomcatDatasourceUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class TomcatDatasourceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public TomcatDatasourceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TomcatDatasourceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TomcatDatasourceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TomcatDatasourceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TomcatDatasourceUnit_type") : //$NON-NLS-1$
			getString("_UI_TomcatDatasourceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
