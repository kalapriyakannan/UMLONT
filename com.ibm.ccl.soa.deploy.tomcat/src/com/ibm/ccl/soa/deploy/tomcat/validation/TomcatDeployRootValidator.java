...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.tomcat.TomcatDeployRoot}. This
...
public interface TomcatDeployRootValidator {
	...
	boolean validateCapabilityTomcat50datasource(Tomcat50Datasource value);

	boolean validateCapabilityTomcatServer(TomcatServer value);

	boolean validateUnitTomcatdatasource(TomcatDatasourceUnit value);

	boolean validateUnitTomcatWebServer(TomcatWebServerUnit value);
}
