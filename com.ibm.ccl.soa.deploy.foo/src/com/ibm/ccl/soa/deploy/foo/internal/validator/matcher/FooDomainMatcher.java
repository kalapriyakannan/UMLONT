 ...
 *******************************************************************************/
package com.ibm.ccl.soa.deploy.foo.internal.validator.matcher;
...
/**
 * Domain specific matcher for the Foo package.
 */
public class FooDomainMatcher extends CoreDomainMatcher {

	/**
	 * Constructor
	 */
	public FooDomainMatcher() {
