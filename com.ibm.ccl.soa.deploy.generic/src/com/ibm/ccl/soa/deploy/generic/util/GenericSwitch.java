...
public class GenericSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GenericPackage.GENERIC_DEPLOY_ROOT: {
				GenericDeployRoot genericDeployRoot = (GenericDeployRoot)theEObject;
				Object result = caseGenericDeployRoot(genericDeployRoot);
