 ...
 * </copyright>
 *
 * $Id: VMwareVirtualImageUnitItemProvider.java,v 1.2 2008/04/17 15:47:24 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VMwareVirtualImageUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VMwareVirtualImageUnitItemProvider
	extends VirtualImageUnitItemProvider
	implements	
	 ...
	 * @generated
	 */
	public VMwareVirtualImageUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VMwareVirtualImageUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VMwareVirtualImageUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VMwareVirtualImageUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VMwareVirtualImageUnit_type") : //$NON-NLS-1$
			getString("_UI_VMwareVirtualImageUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
