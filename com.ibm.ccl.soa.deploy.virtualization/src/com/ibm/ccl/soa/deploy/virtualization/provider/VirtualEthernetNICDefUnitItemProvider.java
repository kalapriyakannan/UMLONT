 ...
 * </copyright>
 *
 * $Id: VirtualEthernetNICDefUnitItemProvider.java,v 1.2 2008/04/17 15:47:25 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VirtualEthernetNICDefUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualEthernetNICDefUnitItemProvider
	 ...
	 * @generated
	 */
	public VirtualEthernetNICDefUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VirtualEthernetNICDefUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VirtualEthernetNICDefUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VirtualEthernetNICDefUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VirtualEthernetNICDefUnit_type") : //$NON-NLS-1$
			getString("_UI_VirtualEthernetNICDefUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
