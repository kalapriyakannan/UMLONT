 ...
 * </copyright>
 *
 * $Id: VMwareESXUnitItemProvider.java,v 1.1 2008/05/08 14:38:29 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VMwareESXUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VMwareESXUnitItemProvider
	extends OperatingSystemUnitItemProvider
	implements	
	 ...
	 * @generated
	 */
	public VMwareESXUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VMwareESXUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VMwareESXUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VMwareESXUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VMwareESXUnit_type") : //$NON-NLS-1$
			getString("_UI_VMwareESXUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
