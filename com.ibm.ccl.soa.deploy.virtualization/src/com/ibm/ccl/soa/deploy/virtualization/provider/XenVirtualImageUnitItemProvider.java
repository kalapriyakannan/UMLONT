 ...
 * </copyright>
 *
 * $Id: XenVirtualImageUnitItemProvider.java,v 1.2 2008/04/17 15:47:25 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.XenVirtualImageUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XenVirtualImageUnitItemProvider
	 ...
	 * @generated
	 */
	public XenVirtualImageUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns XenVirtualImageUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XenVirtualImageUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((XenVirtualImageUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XenVirtualImageUnit_type") : //$NON-NLS-1$
			getString("_UI_XenVirtualImageUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
