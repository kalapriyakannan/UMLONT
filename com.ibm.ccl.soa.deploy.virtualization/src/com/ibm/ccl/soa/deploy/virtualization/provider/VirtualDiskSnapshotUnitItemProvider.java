 ...
 * </copyright>
 *
 * $Id: VirtualDiskSnapshotUnitItemProvider.java,v 1.1 2008/04/17 15:47:25 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VirtualDiskSnapshotUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualDiskSnapshotUnitItemProvider
	 ...
	 * @generated
	 */
	public VirtualDiskSnapshotUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VirtualDiskSnapshotUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VirtualDiskSnapshotUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VirtualDiskSnapshotUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VirtualDiskSnapshotUnit_type") : //$NON-NLS-1$
			getString("_UI_VirtualDiskSnapshotUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
