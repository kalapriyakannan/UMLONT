 ...
 * </copyright>
 *
 * $Id: VMwareVirtualDiskSnapshotUnitItemProvider.java,v 1.1 2008/04/17 15:47:24 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VMwareVirtualDiskSnapshotUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VMwareVirtualDiskSnapshotUnitItemProvider
	extends VirtualDiskSnapshotUnitItemProvider
	implements	
	 ...
	 * @generated
	 */
	public VMwareVirtualDiskSnapshotUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VMwareVirtualDiskSnapshotUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VMwareVirtualDiskSnapshotUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VMwareVirtualDiskSnapshotUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VMwareVirtualDiskSnapshotUnit_type") : //$NON-NLS-1$
			getString("_UI_VMwareVirtualDiskSnapshotUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
