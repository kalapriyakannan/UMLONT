 ...
 * </copyright>
 *
 * $Id: VirtualDiskDefUnitItemProvider.java,v 1.2 2008/04/17 15:47:25 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VirtualDiskDefUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualDiskDefUnitItemProvider
	 ...
	 * @generated
	 */
	public VirtualDiskDefUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VirtualDiskDefUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VirtualDiskDefUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VirtualDiskDefUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VirtualDiskDefUnit_type") : //$NON-NLS-1$
			getString("_UI_VirtualDiskDefUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
