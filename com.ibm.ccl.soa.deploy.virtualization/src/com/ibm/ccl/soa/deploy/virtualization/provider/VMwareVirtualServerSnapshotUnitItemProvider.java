 ...
 * </copyright>
 *
 * $Id: VMwareVirtualServerSnapshotUnitItemProvider.java,v 1.1 2008/04/17 15:47:24 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.virtualization.VMwareVirtualServerSnapshotUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VMwareVirtualServerSnapshotUnitItemProvider
	extends VirtualServerSnapshotUnitItemProvider
	implements	
	 ...
	 * @generated
	 */
	public VMwareVirtualServerSnapshotUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VMwareVirtualServerSnapshotUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VMwareVirtualServerSnapshotUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VMwareVirtualServerSnapshotUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VMwareVirtualServerSnapshotUnit_type") : //$NON-NLS-1$
			getString("_UI_VMwareVirtualServerSnapshotUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
