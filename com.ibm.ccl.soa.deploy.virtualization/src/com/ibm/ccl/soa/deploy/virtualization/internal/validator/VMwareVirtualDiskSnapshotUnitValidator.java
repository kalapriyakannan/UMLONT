...
/**
 * Validates {@link VMwareVirtualDiskSnapshotUnit}.
 * <p>
 * Validator IDs:
 * <ul>
 * </ul>
...
public class VMwareVirtualDiskSnapshotUnitValidator extends VirtualDiskSnapshotUnitValidator {
	...
	/**
	 * Construct a {@link VMwareVirtualDiskSnapshotUnit} instance validator.
	 */
	...
	/**
	 * Construct a {@link VMwareVirtualDiskSnapshotUnit} subtype validator.
	 * 
	 * @param unitType
	 *           a subtype of {@link VMwareVirtualDiskSnapshotUnit}.
	 */
	protected VMwareVirtualDiskSnapshotUnitValidator(EClass unitType) {
		super(unitType);
		assert VirtualizationPackage.eINSTANCE.getVMwareVirtualDiskSnapshotUnit().isSuperTypeOf(unitType);

		//
		// Constraints on capabilities and requirement types.
		//
		addCapabilityTypeConstraint(VirtualizationPackage.eINSTANCE.getVMwareVirtualDiskSnapshot(),
