 ...
 */
public class VirtualizationPlugin extends Plugin {

	/**
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "com.ibm.ccl.soa.deploy.virtualization"; //$NON-NLS-1$

	// The shared instance
	private static VirtualizationPlugin plugin;

	/**
	 * The constructor
	 */
	public VirtualizationPlugin() {
	}
	 ...
	 */
	public static VirtualizationPlugin getDefault() {
		return plugin;
	}
