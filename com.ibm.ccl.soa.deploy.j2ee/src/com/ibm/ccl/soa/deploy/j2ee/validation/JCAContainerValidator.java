...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.JCAContainer}. This doesn't
 ...
 */
public interface JCAContainerValidator {
	boolean validate();

	boolean validateContainerVersion(JCAContainerVersion value);
}
