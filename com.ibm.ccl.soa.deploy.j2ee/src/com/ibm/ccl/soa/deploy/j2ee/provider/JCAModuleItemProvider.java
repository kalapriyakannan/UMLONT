...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.JCAModule} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class JCAModuleItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public JCAModuleItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JCAModule.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JCAModule")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JCAModule) object).getDisplayName();
		label = (label == null || label.length() == 0) ? ((JCAModule) object).getName() : label;
		return label;
	}
