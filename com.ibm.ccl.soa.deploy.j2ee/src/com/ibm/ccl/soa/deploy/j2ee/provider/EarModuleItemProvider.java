...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.EarModule} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class EarModuleItemProvider extends SoftwareComponentItemProvider implements
	 ...
	 * @generated
	 */
	public EarModuleItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns EarModule.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EarModule")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EarModule) object).getDisplayName();
		label = (label == null || label.length() == 0) ? ((EarModule) object).getName() : label;
		return label;
	}
