...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.JarModule} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class JarModuleItemProvider extends SoftwareComponentItemProvider implements
	...
	/**
	 * This returns JarModule.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JarModule")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JarModule) object).getDisplayName();
		label = (label == null || label.length() == 0) ? ((JarModule) object).getName() : label;
		return label;
	}
