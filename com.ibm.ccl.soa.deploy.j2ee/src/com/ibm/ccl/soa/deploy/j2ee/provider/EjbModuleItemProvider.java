...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.EjbModule} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class EjbModuleItemProvider extends SoftwareComponentItemProvider implements
	...
	public String getText(Object object) {
		String label = ((EjbModule) object).getDisplayName();
		label = (label == null || label.length() == 0) ? ((EjbModule) object).getName() : label;
		return label;
	}
