...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.GenericWebServer} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class GenericWebServerItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public GenericWebServerItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenericWebServer.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericWebServer")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((GenericWebServer) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_GenericWebServer_type") : //$NON-NLS-1$
				getString("_UI_GenericWebServer_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
