...
public class StringMatcher {
	 ...
	 * contain '*' for 0 and many characters and '?' for exactly one character.
	 * 
	 ...
	 * 
	 * If invoking the StringMatcher with string literals in Java, don't forget escape characters are
	 * represented by "\\".
	 * 
	 * @param pattern
