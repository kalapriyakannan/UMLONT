...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.GenericJ2eeServer} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class GenericJ2eeServerItemProvider extends GenericWebServerItemProvider implements
	 ...
	 * @generated
	 */
	public GenericJ2eeServerItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenericJ2eeServer.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericJ2eeServer")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((GenericJ2eeServer) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_GenericJ2eeServer_type") : //$NON-NLS-1$
				getString("_UI_GenericJ2eeServer_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
