...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.WSDLInterface}. This doesn't
 ...
 */
public interface WSDLInterfaceValidator {
	boolean validate();

	boolean validateTypeUri(String value);
}
