...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.AppClient} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class AppClientItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public AppClientItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AppClient.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AppClient")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((AppClient) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AppClient_type") : //$NON-NLS-1$
				getString("_UI_AppClient_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
