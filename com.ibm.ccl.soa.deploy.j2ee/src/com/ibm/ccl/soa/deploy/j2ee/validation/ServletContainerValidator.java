...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.ServletContainer}. This
 ...
 */
public interface ServletContainerValidator {
	boolean validate();

	boolean validateContainerVersion(ServletContainerVersion value);
}
