...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.URLInterface}. This doesn't
 ...
 */
public interface URLInterfaceValidator {
	boolean validate();

	boolean validateParamName(EList value);
}
