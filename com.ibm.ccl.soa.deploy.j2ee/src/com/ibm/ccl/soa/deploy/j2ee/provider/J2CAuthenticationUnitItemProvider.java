...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.J2CAuthenticationUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class J2CAuthenticationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public J2CAuthenticationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((J2CAuthenticationUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_J2CAuthenticationUnit_type") : //$NON-NLS-1$
				getString("_UI_J2CAuthenticationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
