...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.WebService} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WebServiceItemProvider extends ServiceItemProvider implements
	...
	protected void addEndpointPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_WebService_endpoint_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_WebService_endpoint_feature", "_UI_WebService_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						J2eePackage.Literals.WEB_SERVICE__ENDPOINT, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WebService")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WebService) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WebService_type") : //$NON-NLS-1$
				getString("_UI_WebService_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
