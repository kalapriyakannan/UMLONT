...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.EJBContainer}. This doesn't
 ...
 */
public interface EJBContainerValidator {
	boolean validate();

	boolean validateContainerVersion(EJBContainerVersion value);
}
