...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.EntityService}. This doesn't
 ...
 */
public interface EntityServiceValidator {
	boolean validate();

	boolean validateManaged(boolean value);
}
