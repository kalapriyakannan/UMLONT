...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.WebModule} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WebModuleItemProvider extends SoftwareComponentItemProvider implements
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/service_web")); //$NON-NLS-1$
	}

	public String getText(Object object) {
		String label = ((WebModule) object).getDisplayName();
		label = label == null || label.length() == 0 ? ((WebModule) object).getName() : label;
		return label;
	}
