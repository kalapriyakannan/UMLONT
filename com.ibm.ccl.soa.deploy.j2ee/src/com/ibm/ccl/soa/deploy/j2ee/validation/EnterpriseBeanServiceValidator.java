...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.j2ee.EnterpriseBeanService}. This
...
public interface EnterpriseBeanServiceValidator {
	...
	boolean validateHomeInterface(JavaInterface value);

	boolean validateEjbName(String value);

	boolean validateJndiName(String value);

	boolean validateVicinity(Vicinity value);
}
