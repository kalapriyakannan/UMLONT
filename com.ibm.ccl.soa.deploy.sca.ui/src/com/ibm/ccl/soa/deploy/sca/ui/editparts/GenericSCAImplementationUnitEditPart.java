 ...
 */
public class GenericSCAImplementationUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public GenericSCAImplementationUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("GenericSCAImplementation"); //$NON-NLS-1$ 
	}
