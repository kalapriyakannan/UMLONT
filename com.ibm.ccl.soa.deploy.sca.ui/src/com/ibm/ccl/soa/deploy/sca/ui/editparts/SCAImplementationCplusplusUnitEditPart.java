 ...
 */
public class SCAImplementationCplusplusUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public SCAImplementationCplusplusUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("SCAImplementationCplusplus"); //$NON-NLS-1$ 
	}
