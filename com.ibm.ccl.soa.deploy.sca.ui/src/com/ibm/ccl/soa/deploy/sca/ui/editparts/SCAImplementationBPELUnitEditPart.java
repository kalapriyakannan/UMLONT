 ...
 */
public class SCAImplementationBPELUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public SCAImplementationBPELUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("SCAImplementationBPEL"); //$NON-NLS-1$ 
	}
