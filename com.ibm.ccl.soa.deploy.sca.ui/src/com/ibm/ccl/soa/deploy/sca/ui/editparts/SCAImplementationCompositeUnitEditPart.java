 ...
 */
public class SCAImplementationCompositeUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public SCAImplementationCompositeUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("SCAImplementationComposite"); //$NON-NLS-1$ 
	}
