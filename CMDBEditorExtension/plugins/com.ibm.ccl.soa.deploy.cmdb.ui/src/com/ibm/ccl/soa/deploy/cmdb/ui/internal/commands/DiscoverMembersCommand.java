 ...
 */
public class DiscoverMembersCommand extends AbstractDiscoverCommand {
	 ...
	 *            the figures).
	 */
	public DiscoverMembersCommand(List<Unit> selectedUnits, List selectedParts,
			DiagramEditPart targetEP, Point point) {
		super(selectedUnits, selectedParts, targetEP, point);
	}

	/**
	 * Returns a list of member descriptors for the unit.
	 * 
	 * @param unit
	...
	public List<UnitDescriptor> getUnitDescriptors(Unit unit,
		...
		return TopologyDiscovererService.INSTANCE.getMembers(unit, null, unit
		 ...
		 * descrs = TopologyDiscovererService.INSTANCE .getMembers(unit, req,
