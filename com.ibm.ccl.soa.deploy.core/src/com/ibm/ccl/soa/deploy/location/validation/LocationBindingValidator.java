...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.location.LocationBinding}. This
...
public interface LocationBindingValidator {
	...
	boolean validateBindingEntry(List value);

	boolean validateContext(String value);

	boolean validateName(String value);

	boolean validateTopology(String value);
}
