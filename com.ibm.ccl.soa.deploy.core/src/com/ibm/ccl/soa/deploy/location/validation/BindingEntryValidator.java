...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.location.BindingEntry}. This
 ...
 */
public interface BindingEntryValidator {
	boolean validate();

	boolean validateDmoPath(String value);
