...
/**
 * Generates resolutions for instantiations of non-public imported objects.
 * 
 * @see ICoreProblemType#IMPORT_INSTANTIATION_OBJECT_NOT_PUBLIC
 */
public class ImportInstantationObjectNotPublicResolutionGenerator extends DeployResolutionGenerator {
	...
	public IDeployResolution[] getResolutions(IDeployResolutionContext context) {
		return new IDeployResolution[] { new RemoveInstantiationResolution(context, this) };
	}
	...
	public boolean hasResolutions(IDeployResolutionContext context) {
		...
		return ICoreProblemType.IMPORT_INSTANTIATION_OBJECT_NOT_PUBLIC
