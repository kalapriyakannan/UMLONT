 ...
 * 
 */
public class ConfiguredRequirementFeatureMapStrategy extends DefaultFeatureMapStrategy implements
	 ...
	 */
	public ConfiguredRequirementFeatureMapStrategy(InstanceConfiguration persistenceContainer,
	...
	protected FeatureMap.Internal getFeatureMap(Instantiation instantiation) {
		...
		if (instantiation != null && instantiation instanceof InternalInstantiation) {
			return (FeatureMap.Internal) ((InternalInstantiation) instantiation)
					.getConfiguredRequirementsGroup();
		}
		return null;
	}
