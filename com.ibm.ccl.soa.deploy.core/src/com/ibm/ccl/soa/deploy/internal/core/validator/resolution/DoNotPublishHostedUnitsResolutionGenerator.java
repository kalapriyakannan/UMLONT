...
public class DoNotPublishHostedUnitsResolutionGenerator extends DeployResolutionGenerator {
	...
	public IDeployResolution[] getResolutions(IDeployResolutionContext context) {
		return new IDeployResolution[] { new DoNotPublishHostedUnitsResolution(context, this) };
	}
	...
	public boolean hasResolutions(IDeployResolutionContext context) {
		return (context.getDeployStatus().getDeployObject() instanceof Unit)
				&& (ICoreProblemType.UNIT_DO_NOT_PUBLISH_HOSTS_PUBLISH_UNITS.equals(context
