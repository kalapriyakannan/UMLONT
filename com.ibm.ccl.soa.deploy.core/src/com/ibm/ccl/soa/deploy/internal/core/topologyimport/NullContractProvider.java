...
public class NullContractProvider extends ContractProvider {
	...
	public static final String ID = "com.ibm.ccl.soa.deploy.core.NullContract"; //$NON-NLS-1$ 

	@Override
	public void installContract(Topology topology) {

		ExplicitContract contract = CoreFactory.eINSTANCE.createExplicitContract();
		contract.setDefaultConceptualPolicy(Visibility.get(Visibility.PRIVATE));
		contract.setDefaultPolicy(Visibility.get(Visibility.PRIVATE));
