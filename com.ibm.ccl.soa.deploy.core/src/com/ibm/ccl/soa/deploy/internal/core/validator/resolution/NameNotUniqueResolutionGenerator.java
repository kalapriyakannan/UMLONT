 ...
 */
public class NameNotUniqueResolutionGenerator extends DeployResolutionGenerator {
	...
	public boolean hasResolutions(IDeployResolutionContext context) {
		...
		if (!ICoreProblemType.OBJECT_ATTRIBUTE_NOT_UNIQUE.equals(status.getProblemType())) {
			return false;
		}
