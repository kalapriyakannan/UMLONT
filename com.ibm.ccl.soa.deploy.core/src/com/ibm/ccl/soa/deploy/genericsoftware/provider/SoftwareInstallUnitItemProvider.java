 ...
 * </copyright>
 *
 * $Id: SoftwareInstallUnitItemProvider.java,v 1.2 2008/02/05 22:20:15 chadh Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.genericsoftware.SoftwareInstallUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SoftwareInstallUnitItemProvider
	 ...
	 * @generated
	 */
	public SoftwareInstallUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SoftwareInstallUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SoftwareInstallUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SoftwareInstallUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SoftwareInstallUnit_type") : //$NON-NLS-1$
			getString("_UI_SoftwareInstallUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
