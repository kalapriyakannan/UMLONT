...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.constraint.TypeConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeConstraint_dmoType_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeConstraint_dmoType_feature", "_UI_TypeConstraint_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TypeConstraint")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TypeConstraint_type") : //$NON-NLS-1$
			getString("_UI_TypeConstraint_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
