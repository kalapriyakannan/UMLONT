...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.core.Import}. This doesn't really
...
public interface ImportValidator {
	...
	boolean validateInstanceConfiguration(InstanceConfiguration value);
