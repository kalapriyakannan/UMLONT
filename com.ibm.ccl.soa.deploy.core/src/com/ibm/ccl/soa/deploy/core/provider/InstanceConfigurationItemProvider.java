...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.InstanceConfiguration} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class InstanceConfigurationItemProvider extends DeployModelObjectItemProvider implements
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.INSTANCE_CONFIGURATION__INSTANTIATIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InstanceConfiguration")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_InstanceConfiguration_type") : //$NON-NLS-1$
			getString("_UI_InstanceConfiguration_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
