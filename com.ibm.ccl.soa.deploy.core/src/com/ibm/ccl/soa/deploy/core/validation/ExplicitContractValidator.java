...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.core.ExplicitContract}. This
...
public interface ExplicitContractValidator {
	...
	boolean validateExportedUnits(List value);

	boolean validateProperties(List value);

	boolean validateDefaultConceptualPolicy(Visibility value);

	boolean validateDefaultPolicy(Visibility value);
}
