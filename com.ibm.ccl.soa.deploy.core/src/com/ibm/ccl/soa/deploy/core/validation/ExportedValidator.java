...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.core.Exported}. This doesn't
 ...
 */
public interface ExportedValidator {
	boolean validate();

	boolean validateConfigurable(boolean value);

	boolean validateLinkable(boolean value);
