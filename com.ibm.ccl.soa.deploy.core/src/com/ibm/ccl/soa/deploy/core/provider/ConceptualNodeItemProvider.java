...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.ConceptualNode} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ConceptualNodeItemProvider extends UnitItemProvider implements
		IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
		IItemLabelProvider, IItemPropertySource {

	private static final String CONCEPTUAL_NAME = "Conceptual"; //$NON-NLS-1$
	/**
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public ConceptualNodeItemProvider(AdapterFactory adapterFactory) {
		super(adapterFactory);
	}

	//removed the conceptual property descriptor
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			super.getPropertyDescriptors(object);
			for (Iterator iter = itemPropertyDescriptors.iterator(); iter.hasNext();) {
				ItemPropertyDescriptor descriptor = (ItemPropertyDescriptor) iter.next();
				String displayName = descriptor.getDisplayName(null);
				if (displayName.equals(CONCEPTUAL_NAME)) {
	...
	/**
	 * This returns ConceptualNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		String label = ((ConceptualNode) object).getDisplayName();
		return label == null || label.length() == 0 ? getString("_UI_ConceptualNode_type") : //$NON-NLS-1$
				label;
	}
