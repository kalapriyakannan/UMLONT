...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Group Cardinality Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.core.constraint.impl.GroupCardinalityConstraintImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.core.constraint.impl.GroupCardinalityConstraintImpl#getMinValue <em>Min Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GroupCardinalityConstraintImpl extends ConstraintImpl implements
	 ...
	 * @generated
	 */
	protected GroupCardinalityConstraintImpl() {
		super();
	}
	...
	public void setMaxValue(String newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintPackage.GROUP_CARDINALITY_CONSTRAINT__MAX_VALUE, oldMaxValue, maxValue, !oldMaxValueESet));
	}
	...
	public void unsetMaxValue() {
		...
		maxValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ConstraintPackage.GROUP_CARDINALITY_CONSTRAINT__MAX_VALUE, oldMaxValue, MAX_VALUE_EDEFAULT, oldMaxValueESet));
	}
	...
	public void setMinValue(String newMinValue) {
		...
		minValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintPackage.GROUP_CARDINALITY_CONSTRAINT__MIN_VALUE, oldMinValue, minValue, !oldMinValueESet));
	}
	...
	public void unsetMinValue() {
		...
		minValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ConstraintPackage.GROUP_CARDINALITY_CONSTRAINT__MIN_VALUE, oldMinValue, MIN_VALUE_EDEFAULT, oldMinValueESet));
	}
...
} //GroupCardinalityConstraintImpl
