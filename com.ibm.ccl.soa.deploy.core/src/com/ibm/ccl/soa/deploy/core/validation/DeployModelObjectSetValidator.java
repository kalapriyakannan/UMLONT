...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.core.DeployModelObjectSet}. This
...
public interface DeployModelObjectSetValidator {
	...
	boolean validateDeployModelObjectGroup(FeatureMap value);

	boolean validateDeployModelObject(List value);
}
