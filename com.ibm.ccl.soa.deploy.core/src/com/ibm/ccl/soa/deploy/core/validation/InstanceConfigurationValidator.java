...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.core.InstanceConfiguration}. This
 ...
 */
public interface InstanceConfigurationValidator {
	boolean validate();

	boolean validateInstantiations(List value);

	boolean validateImported(Import value);
}
