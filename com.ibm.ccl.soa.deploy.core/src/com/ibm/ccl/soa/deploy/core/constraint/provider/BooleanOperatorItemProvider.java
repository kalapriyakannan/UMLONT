...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.constraint.BooleanOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanOperatorItemProvider
	...
	public String getText(Object object) {
		String label = ((BooleanOperator)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BooleanOperator_type") : //$NON-NLS-1$
			getString("_UI_BooleanOperator_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
