...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.Reference} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ReferenceItemProvider extends RequirementItemProvider implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_range_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_range_feature", "_UI_Reference_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CorePackage.Literals.REFERENCE__RANGE,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.REFERENCE__INTERFACE_GROUP);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Reference_type") : //$NON-NLS-1$
