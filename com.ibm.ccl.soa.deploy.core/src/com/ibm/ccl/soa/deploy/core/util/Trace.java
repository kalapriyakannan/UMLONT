...
/**
 * A utility for tracing debug information. Provides a simple interface for filtering and generating
 * trace output.
 * 
 * @author khussey
...
public class Trace {
	 ...
	 *           The new value.
	 */
	public static void changing(Plugin plugin, String option, String valueDescription,
	 ...
	 *           The new value.
	 */
	public static void changing(Plugin plugin, String option, Class clazz, String methodName,
	 ...
	 * 
	 */
	public static void catching(Plugin plugin, String option, Class clazz, String methodName,
			Throwable throwable) {

		if (shouldTrace(plugin, option)) {

			trace(PREFIX_CATCHING + throwable.getMessage() + SEPARATOR_SPACE + PARENTHESIS_OPEN
	...
	/**
	 * Traces the throwing of the specified throwable from the specified method of the specified
	 * class.
	 * 
	 * @param plugin
	 *           The plug-in from which to trace.
	 ...
	 * @param methodName
	 *           The name of the method from which the throwable is being thrown.
	 * @param throwable
	 *           The throwable that is being thrown.
	 * 
	 */
	public static void throwing(Plugin plugin, String option, Class clazz, String methodName,
			Throwable throwable) {

		if (shouldTrace(plugin, option)) {

			trace(PREFIX_THROWING + throwable.getMessage() + SEPARATOR_SPACE + PARENTHESIS_OPEN
					+ clazz.getName() + SEPARATOR_METHOD + methodName + PARENTHESIS_CLOSE);
	...
	/**
	 * Traces the entering into the specified method of the specified class, with the specified
	 * parameter.
	 * 
	 * @param plugin
	 *           The plug-in from which to trace.
	...
	/**
	 * Traces the exiting from the specified method of the specified class, with the specified return
	 * value.
	 * 
	 * @param plugin
	 *           The plug-in from which to trace.
	...
	public static void trace(Plugin plugin, String option, DeployModelObject dmo, String message) {
		trace(plugin, option, dmo.getDisplayName() + " (" + dmo.getFullPath() + "): " + message); //$NON-NLS-1$//$NON-NLS-2$
