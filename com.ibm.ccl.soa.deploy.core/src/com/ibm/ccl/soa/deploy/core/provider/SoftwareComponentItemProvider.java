...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.SoftwareComponent} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class SoftwareComponentItemProvider extends BaseComponentUnitItemProvider implements
	...
	public String getText(Object object) {
		String label = ((SoftwareComponent) object).getDisplayName();
		label = (label == null || label.length() == 0) ? ((SoftwareComponent) object).getName()
				: label;
		return label == null || label.length() == 0 ? ((SoftwareComponent) object).getName() : label;
	}
