 ...
 *
 * $Id: StereotypeImpl.java,v 1.1 2008/02/05 22:20:17 chadh Exp $
 */
 ...
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.core.impl.StereotypeImpl#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.core.impl.StereotypeImpl#getProfile <em>Profile</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.core.impl.StereotypeImpl#isRequired <em>Required</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StereotypeImpl extends EObjectImpl implements Stereotype {
	...
	public void setKeyword(String newKeyword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STEREOTYPE__KEYWORD, oldKeyword, keyword));
	}
	...
	public void setProfile(String newProfile) {
		...
		profile = newProfile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STEREOTYPE__PROFILE, oldProfile, profile));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		requiredESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STEREOTYPE__REQUIRED, oldRequired, required, !oldRequiredESet));
	}
	...
	public void unsetRequired() {
		...
		requiredESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.STEREOTYPE__REQUIRED, oldRequired, REQUIRED_EDEFAULT, oldRequiredESet));
	}
