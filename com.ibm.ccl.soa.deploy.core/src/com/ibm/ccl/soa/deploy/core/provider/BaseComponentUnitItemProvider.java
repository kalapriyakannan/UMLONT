 ...
 *
 * $Id: BaseComponentUnitItemProvider.java,v 1.2 2008/02/05 22:20:18 chadh Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.core.BaseComponentUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BaseComponentUnitItemProvider
	 ...
	 * @generated
	 */
	public BaseComponentUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns BaseComponentUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BaseComponentUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((BaseComponentUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BaseComponentUnit_type") : //$NON-NLS-1$
			getString("_UI_BaseComponentUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
