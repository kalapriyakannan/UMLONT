 ...
 * {@link com.ibm.ccl.soa.deploy.core.constraint.CollocationConstraint}. This doesn't really do
...
public interface CollocationConstraintValidator {
	...
	boolean validateCapabilityType(QName value);

	boolean validateType(CollocationConstraintTypes value);
}
