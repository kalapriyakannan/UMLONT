...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.core.constraint.RangeConstraint}.
...
public interface RangeConstraintValidator {
	...
	boolean validateMaxValueInclusive(boolean value);

	boolean validateMinValue(String value);

	boolean validateMinValueInclusive(boolean value);
