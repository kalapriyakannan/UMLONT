 ...
 * 
 */
public class UnitEditHelper extends ContainerEditHelper {

	protected ICommand getConfigureCommand(final ConfigureRequest req) {
		return new ConfigureBaseCommand(req, CorePackage.eINSTANCE.getUnit()) {
			protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) {
				Unit unit = (Unit) req.getElementToConfigure();
