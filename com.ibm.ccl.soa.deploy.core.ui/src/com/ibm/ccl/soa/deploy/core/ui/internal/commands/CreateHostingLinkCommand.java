 ...
 * 
 */
public class CreateHostingLinkCommand extends CreateRelationshipCommand {

	/**
	 * 
	 * @param request
	 */
	public CreateHostingLinkCommand(CreateRelationshipRequest request) {
		super(request);
	...
	/**
	 * determine if any HostingLink can be created
	 */
