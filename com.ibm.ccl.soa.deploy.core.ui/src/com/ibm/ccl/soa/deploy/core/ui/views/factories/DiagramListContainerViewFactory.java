 ...
 * 
 */
public class DiagramListContainerViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		getViewService().createNode(semanticAdapter, view,
				DeployCoreConstants.DIAGRAMNODELIST_SEMANTICHINT, ViewUtil.APPEND, persisted,
				getPreferencesHint());
	}
