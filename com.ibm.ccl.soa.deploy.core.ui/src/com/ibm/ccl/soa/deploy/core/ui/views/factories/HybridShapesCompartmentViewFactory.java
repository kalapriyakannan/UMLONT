 ...
 * 
 */
public class HybridShapesCompartmentViewFactory extends ResizableCompartmentViewFactory {
	/**
	...
	public View createView(IAdaptable semanticAdapter, View containerView, String semanticHint,
		...
		View view = super.createView(semanticAdapter, containerView, semanticHint, index, true,
				preferencesHint);
		view.getStyles().addAll(createStyles(view));
		return view;
	}
	...
	protected void decorateView(View containerView, View view, IAdaptable element,
		...
		ViewUtil.setStructuralFeatureValue(view,
				NotationPackage.eINSTANCE.getDrawerStyle_Collapsed(), Boolean.TRUE);
	}
}
