 ...
 * @author jeswanke
 */
public class HybridShapesCreationEditPolicy extends CreationEditPolicy {
	...
	protected Command getCreateElementAndViewCommand(CreateViewAndElementRequest request) {
		...
		/*
		 * next we create the command that will create the objects and views and any member link to
		 * this group
		 */
		...
		DeployCreateElementAndViewCommand createElementAndViewCommand = new DeployCreateElementAndViewCommand(
				...
				DeployCreateElementAndViewCommand.HYBRID_SHAPE_CONTAINER, semanticHint, request,
		...
		/*
		 * make sure unit collection compartment is expanded
		 */
