 ...
 * 
 */
public class ImportShapesContainerViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		getViewService().createNode(semanticAdapter, view,
				DeployCoreConstants.IMPORTTOPOLOGYSHAPES_SEMANTICHINT, ViewUtil.APPEND, persisted,
				getPreferencesHint());
	}
