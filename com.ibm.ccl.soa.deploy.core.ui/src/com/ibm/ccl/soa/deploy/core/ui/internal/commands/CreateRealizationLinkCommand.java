...
/**
 * Command to create a realization link.
 * 
...
public class CreateRealizationLinkCommand extends CreateRelationshipCommand {
	 ...
	 * @param request
	 */
	public CreateRealizationLinkCommand(CreateRelationshipRequest request) {
		super(request);
	...
	public boolean canExecute() {
		...
		if (descriptor == null) {
			...
			return dvs.canCreateLink((Unit) source, (Unit) target, LinkType.REALIZATION_SET,
