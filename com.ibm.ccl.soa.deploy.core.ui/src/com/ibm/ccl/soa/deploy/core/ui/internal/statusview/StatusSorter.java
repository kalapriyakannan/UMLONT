...
/**
 * the sorter that can sort status node in status view.
 * 
 * @author <a href="mailto:fenglin@cn.ibm.com">Ella Feng</a>
 * 
 */
public class StatusSorter extends ViewerSorter implements Comparator {
	/**
	 * 
	 */
	 ...
	 * @param other
	 */
	public StatusSorter(StatusSorter other) {
	 ...
	 */
	public StatusSorter(IStatusField[] properties, final int[] defaultPriorities,
		...
		if (properties == null
			...
			System
					.arraycopy(defaultPriorities, 0, this.defaultPriorities, 0, defaultPriorities.length);
			this.defaultDirections = new int[defaultDirections.length];
			System
					.arraycopy(defaultDirections, 0, this.defaultDirections, 0, defaultDirections.length);
		}
	}

	/**
	 * Return a StatusSorter based on the supplied fields.
	 * 
	 * @param sortingFields
	 */
	public static StatusSorter createStatusSorter(IStatusField[] sortingFields) {
		...
		return new StatusSorter(sortingFields, defaultPriorities, directions);
	}
	 ...
	 * @param property
	 */
	public void setTopPriority(IStatusField property) {
	 ...
	 * @return IStatusField
	 */
	public IStatusField getTopField() {
	...
	/**
	 * Compare obj1 and obj2 at depth. If continueSearching continue searching below depth to
	...
	protected int compare(Object obj1, Object obj2, int depth, boolean continueSearching) {
		...
		IStatusField property = fields[column];
	...
	/**
	 * @return IStatusField[] an array of fields
	 */
	public IStatusField[] getFields() {
		return fields;
	}
	...
	public void sort(final Viewer viewer, Object[] elements, int start, int end) {
		Arrays.sort(elements, start, end, new Comparator() {
			public int compare(Object a, Object b) {
				return StatusSorter.this.compare(viewer, a, b);
			}
		});
	}
