 ...
 * 
 */
public class ShapesContainerViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		// append a view that will contain the shapes
		getViewService().createNode(semanticAdapter, view,
				DeployCoreConstants.HYBRIDSHAPES_SEMANTICHINT, ViewUtil.APPEND, persisted,
				getPreferencesHint());
	}
