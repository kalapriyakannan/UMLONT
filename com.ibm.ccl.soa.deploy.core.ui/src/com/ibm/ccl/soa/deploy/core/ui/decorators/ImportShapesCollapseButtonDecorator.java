 ...
 */
public class ImportShapesCollapseButtonDecorator extends ShapesCollapseButtonDecorator {

	/**
	 * @param decoratorTarget
	 */
	public ImportShapesCollapseButtonDecorator(IDecoratorTarget decoratorTarget) {
	...
	protected View getCompartmentView() {
		...
		while (it.hasNext()) {
			...
			if (child.getType().equals(DeployCoreConstants.IMPORTTOPOLOGYSHAPES_SEMANTICHINT)) {
				return child;
			}
		}
		return null;
