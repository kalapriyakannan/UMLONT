...
public class DragFeedbackTooltip extends Figure {
	 ...
	 * @param diagramEP
	 */
	public DragFeedbackTooltip(DeployDiagramEditPart diagramEP) {
		super();
	...
	public void setPosition(Point p) {
		IFigure figure = LayerManager.Helper.find(_diagramEP)
		...
		Rectangle r = _diagramEP.getViewer().getControl().getBounds();
		r.width += d.x - 15;
		r.height += d.y - 15;
