...
/**
 * Provides a UI-aware version of SynchronizationDatamodel API class, that can
 ...
 */
public class UISynchronizationDatamodel extends SynchronizationDatamodel {
	/**
   * @generated (mde.utilities.datamodels)
   */
   ...
   */
    ...
    return new UISynchronizationDatamodel(model);
  }
   ...
   * @generated (mde.utilities.datamodels)
   */
	public UISynchronizationDatamodel(IDataModel mdl) {
    super(mdl);
