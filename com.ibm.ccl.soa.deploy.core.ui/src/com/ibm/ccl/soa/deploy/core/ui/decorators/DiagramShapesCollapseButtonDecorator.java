...
public class DiagramShapesCollapseButtonDecorator extends ShapesCollapseButtonDecorator {
	 ...
	 */
	public DiagramShapesCollapseButtonDecorator(IDecoratorTarget decoratorTarget) {
	...
	protected View getCompartmentView() {
		...
		while (it.hasNext()) {
			...
			if (child.getType().equals(DeployCoreConstants.DIAGRAMNODESHAPES_SEMANTICHINT)) {
				return child;
			}
		}
		return null;
