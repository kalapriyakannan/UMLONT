 ...
 * 
 * @author Ed Snible (based on jswanke)
 * @see RealizationLinkConnection
 * @see RealizationLink
 */
public class RealizationLinkEditPart extends DeployConnectionNodeEditPart implements
	...
	protected void refreshVisuals() {
		...
		getFigure().setForegroundColor(DeployColorConstants.realizationLinkColor);
...
} // end class RealizationLinkEditPart
