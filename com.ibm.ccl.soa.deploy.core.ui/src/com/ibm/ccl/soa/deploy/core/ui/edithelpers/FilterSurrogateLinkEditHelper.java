 ...
 * 
 */
public class FilterSurrogateLinkEditHelper extends DeployCoreBaseEditHelper {

	public FilterSurrogateLinkEditHelper() {
		// do nothing
	}
...
//				LogicalLink link = (LogicalLink) req.getElementToConfigure();
