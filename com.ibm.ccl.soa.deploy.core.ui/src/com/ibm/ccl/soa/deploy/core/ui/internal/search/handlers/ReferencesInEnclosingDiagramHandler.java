...
public class ReferencesInEnclosingDiagramHandler extends AbstractReferencesHandler {
	...
	protected Scope getSearchScope(ExecutionEvent event) throws CoreException, ExecutionException {
		...
		throw new CoreException(
				new Status(
						...
						Messages.ReferencesInEnclosingDiagramHandler_Could_not_determine_topology_diagra_,
						null));
	}
	...
	private IFile getDiagramOfCurrentSelection(ExecutionEvent event) throws CoreException,
		...
		if (!(object instanceof EObject)) {
			throw new CoreException(new Status(IStatus.ERROR, DeployCoreUIPlugin.PLUGIN_ID,
					Messages.ReferencesInEnclosingDiagramHandler_Selection_was_not_an_instance_of_EO_,
					null));
		}
