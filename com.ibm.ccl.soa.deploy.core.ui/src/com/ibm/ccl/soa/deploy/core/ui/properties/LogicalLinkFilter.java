 ...
 * 
 * <p>
 * Returns false for everything except EditParts that refer to SOA Deploy {@link ConstraintLink}s.
 * 
 * @author snible@us.ibm.com
 * @deprecated
 */
public class LogicalLinkFilter implements IFilter {
	...
	public boolean select(Object object) {
		if (object instanceof AbstractConnectionEditPart) {
			...
			if (acep.getModel() instanceof Edge) {
				...
				if (edge.getElement() instanceof ConstraintLink) {
					return true;
				}
			}
		}
