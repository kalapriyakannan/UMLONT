 ...
 */
public class DependencyLinkEditPart extends DeployConnectionNodeEditPart implements
	 ...
	 * @param view
	 */
	public DependencyLinkEditPart(final View view) {
		super(view);
		...
		if (_contentObject != null) {
			_contentAdapter = new EContentAdapter() {
				public void notifyChanged(Notification aNotification) {
					if (aNotification.getNotifier() instanceof DependencyLink
	...
	protected Connection createConnectionFigure() {
		return DeployCoreFigureFactory.createNewDependencyLink(this);
	}
...
} // end class DependencyLinkEditPart
