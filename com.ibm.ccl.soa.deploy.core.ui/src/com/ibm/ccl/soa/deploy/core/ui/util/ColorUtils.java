...
public final class ColorUtils {
	...
	public static final String copyright = "Licensed Material - Property of IBM <<PART NUMBER - 5724-D15>> (C) Copyright IBM Corp. 2004 - All Rights Reserved. US Government Users Restricted Rights - Use, duplication or disclosure restricted by GSA ADP Schedule Contract with IBM Corp.".intern(); //$NON-NLS-1$

	/**
	 * Gets a different color shade by changing its brightness with the provided variation.
	 */
...
//		System.out.println(new RGB(getRed(rgb), getGreen(rgb), getBlue(rgb)));
	...
	/**
	 * Returns an array of gradient colors from source to destination. The source and destination
	 * colors are not included in the array.
	 */
	...
	/**
	 * Returns an array of gradient colors from source to middle and from middle to destination. The
	 * middle color is included but the source and destination are not.
	 */
	public static Color[] getColorShades(Color source, Color middle, Color destination, int n,
			Display display) {
	...
	/**
	 * Takes the source color and calculates the brightness interval with each color of the shades
	 * array. Then creates a new color array based on the destination color and the brightness
	 * intervals.
	 */
	...
	/**
	 * Fill and return the specified array with the specified RGB values converted to HSB. Create,
	 * fill and return a new array if <code>null</code> is passed in.
	 * <p>
	 ...
	 *           the blue component
	 * @param hsb
	 *           the return value or <code>null</code>
	 * 
	 * @return an <code>float[]</code> containing the converted HSB values
	 * 
	 * @throws IllegalArgumentException
	 *            if any of the components are invalid
	 */
	 ...
	 * @version initial
	 * 
	 * @return an <code>int</code> which is the blue component of the receiver in the range (0 -
	 *         255)
	 * 
	 */
	 ...
	 * @version initial
	 * 
	 * @return an <code>int</code> which is the green component of the receiver in the range (0 -
	 *         255)
	 */
	 ...
	 * @version initial
	 * 
	 * @return an <code>int</code> which is the red component of the receiver in the range (0 -
	 *         255)
	 */
	...
	/**
	 * scales the colors to be relative to the background and foreground colors (used to handle high
	 * contrast mode)
	 * 
	 */
	...
	public static boolean isInvertedColorScheme() {
		...
		if ((baseForeground.getRed() + baseForeground.getBlue() + baseForeground.getGreen()) > (baseBackground
				.getRed()
				+ baseBackground.getBlue() + baseBackground.getGreen())) {
			return true;
		}
		return false;
	}
