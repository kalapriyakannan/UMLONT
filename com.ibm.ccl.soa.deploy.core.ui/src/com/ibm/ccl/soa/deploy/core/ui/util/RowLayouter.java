 ...
 * GridData.horizontalSpan</code>
 * field.
 * 
 * Additionally a row layouter manages a default <code>GridData</code> object for each column. If
 * set this grid data is used for the widget if it doesn't manage its own grid data object.
 * 
 * Call one of the <code>perform</code> methods to assign the correct grid data objects to a set
 * of widgets according to the number of columns passed to the layouter's constructor.
 */
