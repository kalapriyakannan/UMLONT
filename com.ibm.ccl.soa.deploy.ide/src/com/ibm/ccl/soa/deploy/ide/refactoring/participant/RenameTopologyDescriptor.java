...
public class RenameTopologyDescriptor {
	...
	public static RenameTopologyDescriptor createModel() {
		...
		return new RenameTopologyDescriptor(model);
	}
	 ...
	 * @generated (mde.utilities.datamodels)
	 */
	public RenameTopologyDescriptor(IDataModel mdl) {
		model = mdl;
	}
	...
	public void setTopology(String newTopology) {
		model.setProperty(IRenameTopologyModelProperties.TOPOLOGY, newTopology);
	}
	...
	public String getTopology() {
		return (String) model.getProperty(IRenameTopologyModelProperties.TOPOLOGY);
	}
	...
	public IStatus validateTopology() {
		return model.validateProperty(IRenameTopologyModelProperties.TOPOLOGY);
	}
	...
	public String getDefaultTopology() {
		return (String) model
				.getDefaultProperty(IRenameTopologyModelProperties.TOPOLOGY);
	}
	...
	public void setName(String newName) {
		model.setProperty(IRenameTopologyModelProperties.NAME, newName);
	}
	...
	public String getName() {
		return (String) model.getProperty(IRenameTopologyModelProperties.NAME);
	}
	...
	public IStatus validateName() {
		return model.validateProperty(IRenameTopologyModelProperties.NAME);
	}
	...
	public String getDefaultName() {
		return (String) model.getDefaultProperty(IRenameTopologyModelProperties.NAME);
	}
	...
	public IDataModelOperation createConfiguredOperation() {
		RenameTopologyOperation operation = new RenameTopologyOperation(
				this);
		return operation;
	}
