...
/**
 * 
 * Provides a type-specific implementation of the DeleteTopologyChange model.
 * 
 * <p>
 ...
 */
public class DeleteTopologyChangeOperation extends DeployRefactoringChangeOperation implements
	 ...
	 * @generated (mde.utilities.datamodels)
	 */
	public DeleteTopologyChangeOperation(IDataModel dMdl) {
		super(dMdl);
		setTypeSafeModel(new DeleteTopologyChange(dMdl));
	}
	 ...
	 * @generated (mde.utilities.datamodels)
	 */
	public DeleteTopologyChangeOperation(DeleteTopologyChange tsMdl) {
		super(tsMdl);
	...
	protected IStatus doExecute(IProgressMonitor monitor) throws ExecutionException {
		...
		try {
			...
			IFile topologyFile = ResourcesPlugin.getWorkspace().getRoot().getFile(
					typesafeModel.getTopology());

			IEditModelScribbler scribbler = getEditModelScribbler();
			scribbler.deleteResource(topologyFile, monitor);
	 ...
	 * @generated (mde.utilities.datamodels)
	 */
	private void setTypeSafeModel(DeleteTopologyChange mdl) {
		typesafeModel = mdl;
	}
}
