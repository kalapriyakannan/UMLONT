...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.MoveUnitChange }
 * 
 * <p>
 * Clients should use {@link MoveUnitChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.MoveUnitChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.MoveUnitChange 
 */
public class MoveUnitChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		MoveUnitChange typesafeModel = MoveUnitChange.createModel();		
