...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.MoveLinkChange }
 * 
 * <p>
 * Clients should use {@link MoveLinkChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.MoveLinkChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.MoveLinkChange 
 */
public class MoveLinkChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		MoveLinkChange typesafeModel = MoveLinkChange.createModel();		
