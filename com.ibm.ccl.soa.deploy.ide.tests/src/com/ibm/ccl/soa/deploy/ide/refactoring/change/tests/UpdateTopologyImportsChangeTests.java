...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateTopologyImportsChange }
 * 
 * <p>
 * Clients should use {@link UpdateTopologyImportsChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.UpdateTopologyImportsChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateTopologyImportsChange 
 */
public class UpdateTopologyImportsChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		UpdateTopologyImportsChange typesafeModel = UpdateTopologyImportsChange.createModel();		
