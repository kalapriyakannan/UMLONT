...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.MoveResourceChange }
 * 
 * <p>
 * Clients should use {@link MoveResourceChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.MoveResourceChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.MoveResourceChange 
 */
public class MoveResourceChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		MoveResourceChange typesafeModel = MoveResourceChange.createModel();		
