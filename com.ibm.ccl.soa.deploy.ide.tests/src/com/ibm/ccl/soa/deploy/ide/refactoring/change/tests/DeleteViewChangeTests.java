...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.DeleteViewChange }
 * 
 * <p>
 * Clients should use {@link DeleteViewChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.DeleteViewChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.DeleteViewChange 
 */
public class DeleteViewChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		DeleteViewChange typesafeModel = DeleteViewChange.createModel();		
		typesafeModel.setView(null); 
