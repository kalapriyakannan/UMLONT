...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateDiagramElementsChange }
 * 
 * <p>
 * Clients should use {@link UpdateDiagramElementsChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.UpdateDiagramElementsChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateDiagramElementsChange 
 */
public class UpdateDiagramElementsChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		UpdateDiagramElementsChange typesafeModel = UpdateDiagramElementsChange.createModel();		
