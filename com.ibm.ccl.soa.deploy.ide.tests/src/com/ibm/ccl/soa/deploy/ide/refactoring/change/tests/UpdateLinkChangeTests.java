...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateLinkChange }
 * 
 * <p>
 * Clients should use {@link UpdateLinkChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.UpdateLinkChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateLinkChange 
 */
public class UpdateLinkChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		UpdateLinkChange typesafeModel = UpdateLinkChange.createModel();		
		typesafeModel.setLink(null); 		
		typesafeModel.setSource(null); 		
		typesafeModel.setDestination(null); 		
		typesafeModel.setEndpoint(null); 
