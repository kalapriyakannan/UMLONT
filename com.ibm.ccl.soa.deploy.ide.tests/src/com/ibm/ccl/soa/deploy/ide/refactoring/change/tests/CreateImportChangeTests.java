...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.CreateImportChange }
 * 
 * <p>
 * Clients should use {@link CreateImportChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.CreateImportChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.CreateImportChange 
 */
public class CreateImportChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		CreateImportChange typesafeModel = CreateImportChange.createModel();		
		typesafeModel.setImports(null); 		
		typesafeModel.setImported(null); 
