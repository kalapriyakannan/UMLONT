...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.CreateDiagramChange }
 * 
 * <p>
 * Clients should use {@link CreateDiagramChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.CreateDiagramChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.CreateDiagramChange 
 */
public class CreateDiagramChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		CreateDiagramChange typesafeModel = CreateDiagramChange.createModel();		
