...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateDiagramImportsChange }
 * 
 * <p>
 * Clients should use {@link UpdateDiagramImportsChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.operation.UpdateDiagramImportsChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.UpdateDiagramImportsChange 
 */
public class UpdateDiagramImportsChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		UpdateDiagramImportsChange typesafeModel = UpdateDiagramImportsChange.createModel();		
		typesafeModel.setDiagram(null); 		
		typesafeModel.setModel(null); 		
