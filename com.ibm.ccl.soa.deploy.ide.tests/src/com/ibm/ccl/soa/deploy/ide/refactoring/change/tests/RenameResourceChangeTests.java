...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.ide.refactoring.change.RenameResourceChange }
 * 
 * <p>
 * Clients should use {@link RenameResourceChange#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.ide.internal.refactoring.change.RenameResourceChangeOperation
 * @see com.ibm.ccl.soa.deploy.ide.refactoring.change.RenameResourceChange 
 */
public class RenameResourceChangeTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		RenameResourceChange typesafeModel = RenameResourceChange.createModel();		
