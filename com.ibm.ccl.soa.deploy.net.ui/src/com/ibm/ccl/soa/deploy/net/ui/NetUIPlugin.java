 ...
 */
public class NetUIPlugin extends AbstractUIPlugin {

	/**
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "com.ibm.ccl.soa.deploy.net.ui"; //$NON-NLS-1$

	// The shared instance
	private static NetUIPlugin plugin;
	 ...
	 */
	public static NetUIPlugin getDefault() {
		return plugin;
	}
