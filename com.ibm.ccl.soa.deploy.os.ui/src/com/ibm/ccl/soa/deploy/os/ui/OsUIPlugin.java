 ...
 */
public class OsUIPlugin extends AbstractUIPlugin {
	/**
	 * The unique identifier for the RadUI plugin.
	 */
	public static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.os.ui"; //$NON-NLS-1$

	//The shared instance.
	private static OsUIPlugin instance;
	 ...
	 * 
	 * @return return shared instance
	 */
	public static OsUIPlugin getDefault() {
		return instance;
	}
