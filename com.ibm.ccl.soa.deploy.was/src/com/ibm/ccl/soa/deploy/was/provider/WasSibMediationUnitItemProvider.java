...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSibMediationUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasSibMediationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSibMediationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSibMediationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSibMediationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSibMediationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSibMediationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSibMediationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
