...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSibOutboundServiceUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WasSibOutboundServiceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSibOutboundServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSibOutboundServiceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSibOutboundServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSibOutboundServiceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSibOutboundServiceUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSibOutboundServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
