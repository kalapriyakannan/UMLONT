 ...
 * @see com.ibm.ccl.soa.deploy.was.WasPackage#getAcknowledgeModeEnum()
...
public final class AcknowledgeModeEnum extends AbstractEnumerator {
	...
	/**
	 * The '<em><b>Duplicates Ok Auto Acknowledge</b></em>' literal value. <!-- begin-user-doc
	 * --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	 * The session lazily acknowledges the delivery of messages, which can improve performance, but
	 * can lead to a message-driven bean receiving a message more than once.
	 * 
	 * <!-- end-model-doc -->
	 * 
