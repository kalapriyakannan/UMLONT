...
import com.ibm.ccl.soa.deploy.j2ee.jms.provider.JMSQueueDestinationUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasDefaultMessagingQueueDestinationUnit;

/**
 * This is the item provider adapter for a
 * {@link com.ibm.ccl.soa.deploy.was.WasDefaultMessagingQueueDestinationUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class WasDefaultMessagingQueueDestinationUnitItemProvider extends
		JMSQueueDestinationUnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WasDefaultMessagingQueueDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDefaultMessagingQueueDestinationUnit.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDefaultMessagingQueueDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDefaultMessagingQueueDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDefaultMessagingQueueDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDefaultMessagingQueueDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
