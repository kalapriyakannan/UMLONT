...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSibInboundServiceUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WasSibInboundServiceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSibInboundServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSibInboundServiceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSibInboundServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSibInboundServiceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSibInboundServiceUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSibInboundServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
