...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.DerbyJdbcProviderUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DerbyJdbcProviderUnitItemProvider extends ExtendedJdbcProviderUnitItemProvider
	 ...
	 * @generated
	 */
	public DerbyJdbcProviderUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DerbyJdbcProviderUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerbyJdbcProviderUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DerbyJdbcProviderUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DerbyJdbcProviderUnit_type") : //$NON-NLS-1$
			getString("_UI_DerbyJdbcProviderUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
