...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSIBusUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasSIBusUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSIBusUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSIBusUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSIBusUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSIBusUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSIBusUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSIBusUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
