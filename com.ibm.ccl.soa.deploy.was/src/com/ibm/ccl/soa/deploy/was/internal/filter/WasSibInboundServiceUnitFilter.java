...
public class WasSibInboundServiceUnitFilter extends UnitFilter {
	...
	public List<String> getAllowableHostingUnitTypes(Unit anInputUnit) {
		...
		if (anInputUnit.isConceptual() ? list
				.add(IWasTemplateConstants.WAS_SIBUS_INBOUND_PORT_UNIT_CONCEPTUAL) : list
				.add(IWasTemplateConstants.WAS_SIBUS_INBOUND_PORT_UNIT)) {
			;
		}
