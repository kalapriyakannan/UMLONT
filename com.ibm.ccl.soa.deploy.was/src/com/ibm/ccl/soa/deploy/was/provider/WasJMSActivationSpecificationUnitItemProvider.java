...
import com.ibm.ccl.soa.deploy.j2ee.jms.provider.JMSActivationSpecificationUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasJMSActivationSpecificationUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasJMSActivationSpecificationUnit} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class WasJMSActivationSpecificationUnitItemProvider extends
		JMSActivationSpecificationUnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WasJMSActivationSpecificationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasJMSActivationSpecificationUnit.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasJMSActivationSpecificationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasJMSActivationSpecificationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasJMSActivationSpecificationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasJMSActivationSpecificationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
