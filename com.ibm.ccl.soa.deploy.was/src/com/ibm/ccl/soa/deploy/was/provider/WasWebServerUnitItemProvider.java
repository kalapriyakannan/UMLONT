...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasWebServerUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasWebServerUnitItemProvider extends J2EEServerUnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasWebServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasWebServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasWebServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasWebServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasWebServerUnit_type") : //$NON-NLS-1$
			getString("_UI_WasWebServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
