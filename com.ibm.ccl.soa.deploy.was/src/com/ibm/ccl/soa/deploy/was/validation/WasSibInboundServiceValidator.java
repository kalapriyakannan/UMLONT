...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasSibInboundService}. This
 ...
 */
public interface WasSibInboundServiceValidator {
	boolean validate();

	boolean validateServiceName(String value);

	boolean validateWsdlLocation(String value);

	boolean validateWsdlServiceNamespace(String value);
}
