...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSibDestinationUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasSibDestinationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSibDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSibDestinationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSibDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSibDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSibDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSibDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
