...
public class WasDefaultMessagingConnetionFactoryValidator extends JMSConnectionFactoryUnitValidator {
	...
	public WasDefaultMessagingConnetionFactoryValidator() {
		this(WasPackage.Literals.WAS_DEFAULT_MESSAGING_CONNECTION_FACTORY_UNIT);
	}

	public WasDefaultMessagingConnetionFactoryValidator(EClass unitType) {
		super(unitType);
