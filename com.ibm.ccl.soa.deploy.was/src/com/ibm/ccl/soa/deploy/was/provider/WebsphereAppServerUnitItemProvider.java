...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WebsphereAppServerUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WebsphereAppServerUnitItemProvider extends J2EEServerUnitItemProvider implements
	 ...
	 * @generated
	 */
	public WebsphereAppServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WebsphereAppServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WebsphereAppServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WebsphereAppServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WebsphereAppServerUnit_type") : //$NON-NLS-1$
			getString("_UI_WebsphereAppServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
