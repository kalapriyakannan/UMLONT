...
import com.ibm.ccl.soa.deploy.j2ee.jms.provider.JMSTopicConnectionFactoryUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasDefaultMessagingTopicConnectionFactoryUnit;

/**
 * This is the item provider adapter for a
 * {@link com.ibm.ccl.soa.deploy.was.WasDefaultMessagingTopicConnectionFactoryUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class WasDefaultMessagingTopicConnectionFactoryUnitItemProvider extends
		JMSTopicConnectionFactoryUnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WasDefaultMessagingTopicConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDefaultMessagingTopicConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDefaultMessagingTopicConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDefaultMessagingTopicConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDefaultMessagingTopicConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDefaultMessagingTopicConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
