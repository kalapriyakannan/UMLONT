...
/**
 * Resolution to add a starting weight constraint
 */
public class AddWasModuleStartingWeightConstraintResolution extends DeployResolution {
	 ...
	 */
	public AddWasModuleStartingWeightConstraintResolution(IDeployResolutionContext context,
	...
	public IStatus resolve(IProgressMonitor monitor) {
		...
		modules.add(_module);
		WasJ2eeConstraintUtils.addStartWeightConstraints(modules);
