...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasNodeGroupUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasNodeGroupUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasNodeGroupUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasNodeGroupUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasNodeGroupUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasNodeGroupUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasNodeGroupUnit_type") : //$NON-NLS-1$
			getString("_UI_WasNodeGroupUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
