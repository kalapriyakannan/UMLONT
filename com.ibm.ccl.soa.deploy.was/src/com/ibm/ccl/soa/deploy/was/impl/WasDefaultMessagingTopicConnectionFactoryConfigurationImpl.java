...
import com.ibm.ccl.soa.deploy.j2ee.jms.impl.JMSTopicConnectionFactoryImpl;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Default Messaging Topic Connection Factory Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getClientIdentifier <em>Client Identifier</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getConnectionProximity <em>Connection Proximity</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getDurableSubscriptionHome <em>Durable Subscription Home</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getNonpersistentMessageReliability <em>Nonpersistent Message Reliability</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getPersistentMessageReliability <em>Persistent Message Reliability</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getProviderEndpoints <em>Provider Endpoints</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getReadAhead <em>Read Ahead</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getShareDurableSubscriptions <em>Share Durable Subscriptions</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getTargetInboundTransportChain <em>Target Inbound Transport Chain</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getTargetSignificance <em>Target Significance</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getTargetType <em>Target Type</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingTopicConnectionFactoryConfigurationImpl#getTempTopicNamePrefix <em>Temp Topic Name Prefix</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WasDefaultMessagingTopicConnectionFactoryConfigurationImpl extends
		JMSTopicConnectionFactoryImpl implements
	 ...
	 * @generated
	 */
	protected WasDefaultMessagingTopicConnectionFactoryConfigurationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return WasPackage.Literals.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION;
	}
	...
	public void setCategory(String newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CATEGORY, oldCategory, category));
	}
	...
	public void setClientIdentifier(String newClientIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CLIENT_IDENTIFIER, oldClientIdentifier, clientIdentifier));
	}
	...
	public void setConnectionProximity(ConnectionProximityEnum newConnectionProximity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CONNECTION_PROXIMITY, oldConnectionProximity, connectionProximity, !oldConnectionProximityESet));
	}
	...
	public void unsetConnectionProximity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CONNECTION_PROXIMITY, oldConnectionProximity, CONNECTION_PROXIMITY_EDEFAULT, oldConnectionProximityESet));
	}
	...
	public void setDurableSubscriptionHome(String newDurableSubscriptionHome) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__DURABLE_SUBSCRIPTION_HOME, oldDurableSubscriptionHome, durableSubscriptionHome));
	}
	...
	public void setNonpersistentMessageReliability(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__NONPERSISTENT_MESSAGE_RELIABILITY, oldNonpersistentMessageReliability, nonpersistentMessageReliability, !oldNonpersistentMessageReliabilityESet));
	}
	...
	public void unsetNonpersistentMessageReliability() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__NONPERSISTENT_MESSAGE_RELIABILITY, oldNonpersistentMessageReliability, NONPERSISTENT_MESSAGE_RELIABILITY_EDEFAULT, oldNonpersistentMessageReliabilityESet));
	}
	...
	public void setPersistentMessageReliability(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__PERSISTENT_MESSAGE_RELIABILITY, oldPersistentMessageReliability, persistentMessageReliability, !oldPersistentMessageReliabilityESet));
	}
	...
	public void unsetPersistentMessageReliability() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__PERSISTENT_MESSAGE_RELIABILITY, oldPersistentMessageReliability, PERSISTENT_MESSAGE_RELIABILITY_EDEFAULT, oldPersistentMessageReliabilityESet));
	}
	...
	public void setProviderEndpoints(String newProviderEndpoints) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__PROVIDER_ENDPOINTS, oldProviderEndpoints, providerEndpoints));
	}
	...
	public void setReadAhead(ReadAheadOptimizationEnum newReadAhead) {
		...
		readAheadESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__READ_AHEAD, oldReadAhead, readAhead, !oldReadAheadESet));
	}
	...
	public void unsetReadAhead() {
		...
		readAheadESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__READ_AHEAD, oldReadAhead, READ_AHEAD_EDEFAULT, oldReadAheadESet));
	}
	...
	public void setShareDurableSubscriptions(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__SHARE_DURABLE_SUBSCRIPTIONS, oldShareDurableSubscriptions, shareDurableSubscriptions, !oldShareDurableSubscriptionsESet));
	}
	...
	public void unsetShareDurableSubscriptions() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__SHARE_DURABLE_SUBSCRIPTIONS, oldShareDurableSubscriptions, SHARE_DURABLE_SUBSCRIPTIONS_EDEFAULT, oldShareDurableSubscriptionsESet));
	}
	...
	public void setTarget(String newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET, oldTarget, target));
	}
	...
	public void setTargetInboundTransportChain(String newTargetInboundTransportChain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_INBOUND_TRANSPORT_CHAIN, oldTargetInboundTransportChain, targetInboundTransportChain));
	}
	...
	public void setTargetSignificance(CFTargetSignificanceEnum newTargetSignificance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_SIGNIFICANCE, oldTargetSignificance, targetSignificance, !oldTargetSignificanceESet));
	}
	...
	public void unsetTargetSignificance() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_SIGNIFICANCE, oldTargetSignificance, TARGET_SIGNIFICANCE_EDEFAULT, oldTargetSignificanceESet));
	}
	...
	public void setTargetType(ConnectionFactoryTargetTypeEnum newTargetType) {
		...
		targetTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_TYPE, oldTargetType, targetType, !oldTargetTypeESet));
	}
	...
	public void unsetTargetType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_TYPE, oldTargetType, TARGET_TYPE_EDEFAULT, oldTargetTypeESet));
	}
	...
	public void setTempTopicNamePrefix(String newTempTopicNamePrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TEMP_TOPIC_NAME_PREFIX, oldTempTopicNamePrefix, tempTopicNamePrefix));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CATEGORY:
				return getCategory();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CLIENT_IDENTIFIER:
				return getClientIdentifier();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__CONNECTION_PROXIMITY:
				return getConnectionProximity();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__DURABLE_SUBSCRIPTION_HOME:
				return getDurableSubscriptionHome();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__NONPERSISTENT_MESSAGE_RELIABILITY:
				return getNonpersistentMessageReliability();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__PERSISTENT_MESSAGE_RELIABILITY:
				return getPersistentMessageReliability();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__PROVIDER_ENDPOINTS:
				return getProviderEndpoints();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__READ_AHEAD:
				return getReadAhead();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__SHARE_DURABLE_SUBSCRIPTIONS:
				return getShareDurableSubscriptions();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET:
				return getTarget();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_INBOUND_TRANSPORT_CHAIN:
				return getTargetInboundTransportChain();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_SIGNIFICANCE:
				return getTargetSignificance();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TARGET_TYPE:
				return getTargetType();
			case WasPackage.WAS_DEFAULT_MESSAGING_TOPIC_CONNECTION_FACTORY_CONFIGURATION__TEMP_TOPIC_NAME_PREFIX:
...
} //WasDefaultMessagingTopicConnectionFactoryConfigurationImpl
