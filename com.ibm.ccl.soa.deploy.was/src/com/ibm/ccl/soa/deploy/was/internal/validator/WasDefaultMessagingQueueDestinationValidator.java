...
public class WasDefaultMessagingQueueDestinationValidator extends JMSQueueDestinationUnitValidator {

	public WasDefaultMessagingQueueDestinationValidator() {
		this(WasPackage.eINSTANCE.getWasDefaultMessagingQueueDestinationUnit());
	}

	protected WasDefaultMessagingQueueDestinationValidator(EClass unitType) {
		super(unitType);
		this.addCapabilityTypeConstraint(WasPackage.eINSTANCE
				.getWasDefaultMessagingQueueDestination(), CapabilityLinkTypes.ANY_LITERAL, 1, 1);
