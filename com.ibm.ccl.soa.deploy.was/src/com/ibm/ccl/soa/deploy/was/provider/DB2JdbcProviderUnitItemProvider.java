...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.DB2JdbcProviderUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2JdbcProviderUnitItemProvider extends ExtendedJdbcProviderUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2JdbcProviderUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2JdbcProviderUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2JdbcProviderUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2JdbcProviderUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2JdbcProviderUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2JdbcProviderUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
