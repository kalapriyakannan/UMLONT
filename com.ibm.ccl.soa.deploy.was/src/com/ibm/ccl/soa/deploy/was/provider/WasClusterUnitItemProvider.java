...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasClusterUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasClusterUnitItemProvider extends UnitItemProvider implements
	...
	/**
	 * This returns WasClusterUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasClusterUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasClusterUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasClusterUnit_type") : //$NON-NLS-1$
			getString("_UI_WasClusterUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
