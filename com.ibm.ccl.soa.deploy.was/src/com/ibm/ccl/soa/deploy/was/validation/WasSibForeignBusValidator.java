...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasSibForeignBus}. This
...
public interface WasSibForeignBusValidator {
	...
	boolean validateForeignBusName(String value);

	boolean validateInBoundUserID(String value);

	boolean validateOutBoundUserID(String value);

	boolean validateRoutingDefinitionType(WasRoutingDefinitionTypeEnum value);
}
