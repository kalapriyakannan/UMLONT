 ...
 * {@link com.ibm.ccl.soa.deploy.was.WasDefaultMessagingTopicDestination}. This doesn't really do
 ...
 */
public interface WasDefaultMessagingTopicDestinationValidator {
	boolean validate();

	boolean validateConnectionDeliveryMode(ConnectionDeliveryModeEnum value);

	boolean validateMessageLiveTime(long value);

	boolean validateMessagePriority(int value);
