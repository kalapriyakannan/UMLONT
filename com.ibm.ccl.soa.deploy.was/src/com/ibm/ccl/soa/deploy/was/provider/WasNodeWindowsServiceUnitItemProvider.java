...
import com.ibm.ccl.soa.deploy.os.provider.WindowsLocalServiceUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasNodeWindowsServiceUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasNodeWindowsServiceUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WasNodeWindowsServiceUnitItemProvider extends WindowsLocalServiceUnitItemProvider
	 ...
	 * @generated
	 */
	public WasNodeWindowsServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasNodeWindowsServiceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasNodeWindowsServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasNodeWindowsServiceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasNodeWindowsServiceUnit_type") : //$NON-NLS-1$
			getString("_UI_WasNodeWindowsServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
