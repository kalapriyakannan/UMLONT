...
import com.ibm.ccl.soa.deploy.java.provider.JdbcProviderUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.ExtendedJdbcProviderUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.ExtendedJdbcProviderUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ExtendedJdbcProviderUnitItemProvider extends JdbcProviderUnitItemProvider implements
	 ...
	 * @generated
	 */
	public ExtendedJdbcProviderUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ExtendedJdbcProviderUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtendedJdbcProviderUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ExtendedJdbcProviderUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExtendedJdbcProviderUnit_type") : //$NON-NLS-1$
			getString("_UI_ExtendedJdbcProviderUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
