...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasApplicationExt}. This
 ...
 */
public interface WasApplicationExtValidator {
	boolean validate();

	boolean validateReloadInterval(long value);

	boolean validateShareSessionContext(boolean value);
}
