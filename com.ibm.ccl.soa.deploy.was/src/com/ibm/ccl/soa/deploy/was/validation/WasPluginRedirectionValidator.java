...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasPluginRedirection}. This
 ...
 */
public interface WasPluginRedirectionValidator {
	boolean validate();

	boolean validateWasPluginVersion(String value);
}
