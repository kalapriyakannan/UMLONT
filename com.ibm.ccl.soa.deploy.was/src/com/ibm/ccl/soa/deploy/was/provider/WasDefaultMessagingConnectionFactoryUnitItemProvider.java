...
import com.ibm.ccl.soa.deploy.j2ee.jms.provider.JMSConnectionFactoryUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasDefaultMessagingConnectionFactoryUnit;

/**
 * This is the item provider adapter for a
 * {@link com.ibm.ccl.soa.deploy.was.WasDefaultMessagingConnectionFactoryUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class WasDefaultMessagingConnectionFactoryUnitItemProvider extends
		JMSConnectionFactoryUnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WasDefaultMessagingConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDefaultMessagingConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDefaultMessagingConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDefaultMessagingConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDefaultMessagingConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDefaultMessagingConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
