...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasEndpointListenerUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WasEndpointListenerUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasEndpointListenerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasEndpointListenerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasEndpointListenerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasEndpointListenerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasEndpointListenerUnit_type") : //$NON-NLS-1$
			getString("_UI_WasEndpointListenerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
