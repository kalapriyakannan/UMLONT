...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSibOutboundPortUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasSibOutboundPortUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSibOutboundPortUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSibOutboundPortUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSibOutboundPortUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSibOutboundPortUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSibOutboundPortUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSibOutboundPortUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
