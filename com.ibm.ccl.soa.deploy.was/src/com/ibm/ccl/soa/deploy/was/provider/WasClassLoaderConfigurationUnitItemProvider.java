...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasClassLoaderConfigurationUnit} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class WasClassLoaderConfigurationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasClassLoaderConfigurationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasClassLoaderConfigurationUnit.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasClassLoaderConfigurationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasClassLoaderConfigurationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasClassLoaderConfigurationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasClassLoaderConfigurationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
