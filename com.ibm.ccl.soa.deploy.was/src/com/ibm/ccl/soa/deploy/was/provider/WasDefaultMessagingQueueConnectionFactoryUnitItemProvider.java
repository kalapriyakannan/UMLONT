...
import com.ibm.ccl.soa.deploy.j2ee.jms.provider.JMSQueueConnectionFactoryUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasDefaultMessagingQueueConnectionFactoryUnit;

/**
 * This is the item provider adapter for a
 * {@link com.ibm.ccl.soa.deploy.was.WasDefaultMessagingQueueConnectionFactoryUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class WasDefaultMessagingQueueConnectionFactoryUnitItemProvider extends
		JMSQueueConnectionFactoryUnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WasDefaultMessagingQueueConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDefaultMessagingQueueConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDefaultMessagingQueueConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDefaultMessagingQueueConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDefaultMessagingQueueConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDefaultMessagingQueueConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
