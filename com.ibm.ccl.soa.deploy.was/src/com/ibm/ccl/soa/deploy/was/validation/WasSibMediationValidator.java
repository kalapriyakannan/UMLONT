...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasSibMediation}. This
 ...
 */
public interface WasSibMediationValidator {
	boolean validate();

	boolean validateHandlerListName(String value);

	boolean validateMediationName(String value);
}
