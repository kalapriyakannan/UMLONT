...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSystemUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasSystemUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSystemUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSystemUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSystemUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
