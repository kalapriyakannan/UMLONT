...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasCellUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasCellUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasCellUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasCellUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasCellUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasCellUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasCellUnit_type") : //$NON-NLS-1$
			getString("_UI_WasCellUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
