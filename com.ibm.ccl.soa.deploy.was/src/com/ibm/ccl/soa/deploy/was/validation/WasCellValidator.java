...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasCell}. This doesn't really
 ...
 */
public interface WasCellValidator {
	boolean validate();

	boolean validateCellName(String value);

	boolean validateIsDistributed(boolean value);
