...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasNodeGroup}. This doesn't
 ...
 */
public interface WasNodeGroupValidator {
	boolean validate();

	boolean validateIsDefaultType(boolean value);

	boolean validateNodeGroupName(String value);
}
