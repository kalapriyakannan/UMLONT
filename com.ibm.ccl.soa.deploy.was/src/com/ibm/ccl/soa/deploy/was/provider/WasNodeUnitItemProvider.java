...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasNodeUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasNodeUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasNodeUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasNodeUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasNodeUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasNodeUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasNodeUnit_type") : //$NON-NLS-1$
			getString("_UI_WasNodeUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
