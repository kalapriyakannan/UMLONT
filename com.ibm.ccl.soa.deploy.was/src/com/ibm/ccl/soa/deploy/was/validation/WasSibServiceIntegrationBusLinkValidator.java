 ...
 * {@link com.ibm.ccl.soa.deploy.was.WasSibServiceIntegrationBusLink}. This doesn't really do
...
public interface WasSibServiceIntegrationBusLinkValidator {
	...
	boolean validateBootTrapEndpoints(String value);

	boolean validateForeignBusName(String value);

	boolean validateLinkName(String value);

	boolean validateRemoteMessagingEngineName(String value);
}
