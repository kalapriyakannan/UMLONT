...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasSibInboundPortUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasSibInboundPortUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasSibInboundPortUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasSibInboundPortUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasSibInboundPortUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasSibInboundPortUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasSibInboundPortUnit_type") : //$NON-NLS-1$
			getString("_UI_WasSibInboundPortUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
