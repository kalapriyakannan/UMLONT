...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasJMSActivationSpecification}.
...
public interface WasJMSActivationSpecificationValidator {
	...
	boolean validateDurableScriptionHome(String value);

	boolean validateMaxBatchSize(int value);

	boolean validateMaxConcurrentEndpoints(int value);

	boolean validateShareDurableSubscription(ShareDurableSubscriptionsEnum value);
}
