...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasLdapConfigurationUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WasLdapConfigurationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasLdapConfigurationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasLdapConfigurationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasLdapConfigurationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasLdapConfigurationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasLdapConfigurationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasLdapConfigurationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
