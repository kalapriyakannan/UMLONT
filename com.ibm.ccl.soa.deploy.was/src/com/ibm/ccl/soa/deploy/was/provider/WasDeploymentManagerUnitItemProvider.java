...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasDeploymentManagerUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WasDeploymentManagerUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasDeploymentManagerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDeploymentManagerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDeploymentManagerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDeploymentManagerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDeploymentManagerUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDeploymentManagerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
