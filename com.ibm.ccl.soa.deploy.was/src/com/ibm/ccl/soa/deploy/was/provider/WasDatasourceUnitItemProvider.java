...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WasDatasourceUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WasDatasourceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WasDatasourceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDatasourceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDatasourceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDatasourceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDatasourceUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDatasourceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
