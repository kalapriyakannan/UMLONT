...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Sib Inbound Service</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasSibInboundServiceImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasSibInboundServiceImpl#getWsdlLocation <em>Wsdl Location</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasSibInboundServiceImpl#getWsdlServiceNamespace <em>Wsdl Service Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WasSibInboundServiceImpl extends CapabilityImpl implements WasSibInboundService {
	/**
	 ...
	 * @generated
	 */
	protected WasSibInboundServiceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return WasPackage.Literals.WAS_SIB_INBOUND_SERVICE;
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_SIB_INBOUND_SERVICE__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setWsdlLocation(String newWsdlLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_SIB_INBOUND_SERVICE__WSDL_LOCATION, oldWsdlLocation, wsdlLocation));
	}
	...
	public void setWsdlServiceNamespace(String newWsdlServiceNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_SIB_INBOUND_SERVICE__WSDL_SERVICE_NAMESPACE, oldWsdlServiceNamespace, wsdlServiceNamespace));
	}
