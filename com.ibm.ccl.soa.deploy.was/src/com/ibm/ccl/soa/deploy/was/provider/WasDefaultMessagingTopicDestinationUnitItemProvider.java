...
import com.ibm.ccl.soa.deploy.j2ee.jms.provider.JMSTopicDestinationUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WasDefaultMessagingTopicDestinationUnit;

/**
 * This is the item provider adapter for a
 * {@link com.ibm.ccl.soa.deploy.was.WasDefaultMessagingTopicDestinationUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class WasDefaultMessagingTopicDestinationUnitItemProvider extends
		JMSTopicDestinationUnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WasDefaultMessagingTopicDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WasDefaultMessagingTopicDestinationUnit.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WasDefaultMessagingTopicDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WasDefaultMessagingTopicDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WasDefaultMessagingTopicDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_WasDefaultMessagingTopicDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
