...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Default Messaging Queue Destination</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingQueueDestinationImpl#getConnectionDeliveryMode <em>Connection Delivery Mode</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingQueueDestinationImpl#getMessageLiveTime <em>Message Live Time</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.was.impl.WasDefaultMessagingQueueDestinationImpl#getMessagePriority <em>Message Priority</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WasDefaultMessagingQueueDestinationImpl extends JMSQueueDestinationImpl implements
	 ...
	 * @generated
	 */
	protected WasDefaultMessagingQueueDestinationImpl() {
		super();
	}
	...
	public void setConnectionDeliveryMode(ConnectionDeliveryModeEnum newConnectionDeliveryMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_QUEUE_DESTINATION__CONNECTION_DELIVERY_MODE, oldConnectionDeliveryMode, connectionDeliveryMode, !oldConnectionDeliveryModeESet));
	}
	...
	public void unsetConnectionDeliveryMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_QUEUE_DESTINATION__CONNECTION_DELIVERY_MODE, oldConnectionDeliveryMode, CONNECTION_DELIVERY_MODE_EDEFAULT, oldConnectionDeliveryModeESet));
	}
	...
	public void setMessageLiveTime(long newMessageLiveTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_QUEUE_DESTINATION__MESSAGE_LIVE_TIME, oldMessageLiveTime, messageLiveTime, !oldMessageLiveTimeESet));
	}
	...
	public void unsetMessageLiveTime() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_QUEUE_DESTINATION__MESSAGE_LIVE_TIME, oldMessageLiveTime, MESSAGE_LIVE_TIME_EDEFAULT, oldMessageLiveTimeESet));
	}
	...
	public void setMessagePriority(int newMessagePriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WasPackage.WAS_DEFAULT_MESSAGING_QUEUE_DESTINATION__MESSAGE_PRIORITY, oldMessagePriority, messagePriority, !oldMessagePriorityESet));
	}
	...
	public void unsetMessagePriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WasPackage.WAS_DEFAULT_MESSAGING_QUEUE_DESTINATION__MESSAGE_PRIORITY, oldMessagePriority, MESSAGE_PRIORITY_EDEFAULT, oldMessagePriorityESet));
	}
...
} //WasDefaultMessagingQueueDestinationImpl
