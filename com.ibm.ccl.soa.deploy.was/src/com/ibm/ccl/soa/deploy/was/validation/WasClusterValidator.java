...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasCluster}. This doesn't
...
public interface WasClusterValidator {
	...
	boolean validateClusterName(String value);

	boolean validateCreateReplicationDomain(boolean value);

	boolean validatePreferLocal(boolean value);
