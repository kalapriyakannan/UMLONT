...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasDatasource}. This doesn't
...
public interface WasDatasourceValidator {
	...
	boolean validateConnectionTimeout(String value);

	boolean validateMaxConnections(String value);

	boolean validateMinConnections(String value);

	boolean validateStatementCacheSize(String value);
}
