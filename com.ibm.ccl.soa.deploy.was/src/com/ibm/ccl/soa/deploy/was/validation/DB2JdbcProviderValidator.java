...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.DB2JdbcProvider}. This
 ...
 */
public interface DB2JdbcProviderValidator {
	boolean validate();

	boolean validateJdbcType(JdbcTypeType value);

	boolean validateTemplate(DB2JdbcProviderType value);
}
