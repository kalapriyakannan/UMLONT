...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasSecuritySubject}. This
 ...
 */
public interface WasSecuritySubjectValidator {
	boolean validate();

	boolean validateAccessId(String value);

	boolean validateSubjectName(String value);
}
