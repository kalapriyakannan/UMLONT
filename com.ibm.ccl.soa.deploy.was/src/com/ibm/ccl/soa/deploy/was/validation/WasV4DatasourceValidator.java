...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.was.WasV4Datasource}. This
...
public interface WasV4DatasourceValidator {
	...
	boolean validateDisableAutoConnectionCleanup(boolean value);

	boolean validateIdleTimeout(String value);

	boolean validateOrphanTimeout(String value);
}
