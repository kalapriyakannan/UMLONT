...
import com.ibm.ccl.soa.deploy.j2ee.provider.J2CAuthenticationUnitItemProvider;
import com.ibm.ccl.soa.deploy.was.WASJ2CAuthenticationUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.was.WASJ2CAuthenticationUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WASJ2CAuthenticationUnitItemProvider extends J2CAuthenticationUnitItemProvider
	 ...
	 * @generated
	 */
	public WASJ2CAuthenticationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WASJ2CAuthenticationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WASJ2CAuthenticationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WASJ2CAuthenticationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WASJ2CAuthenticationUnit_type") : //$NON-NLS-1$
			getString("_UI_WASJ2CAuthenticationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
