...
import com.ibm.ccl.soa.deploy.database.provider.DatabaseUnitItemProvider;
import com.ibm.ccl.soa.deploy.internal.derby.DerbyDatabaseUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.internal.derby.DerbyDatabaseUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerbyDatabaseUnitItemProvider extends DatabaseUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DerbyDatabaseUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DerbyDatabaseUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerbyDatabaseUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DerbyDatabaseUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DerbyDatabaseUnit_type") : //$NON-NLS-1$
			getString("_UI_DerbyDatabaseUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
