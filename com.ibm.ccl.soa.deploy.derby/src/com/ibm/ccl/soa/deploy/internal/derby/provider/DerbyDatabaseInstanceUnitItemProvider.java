...
import com.ibm.ccl.soa.deploy.database.provider.DatabaseInstanceUnitItemProvider;
import com.ibm.ccl.soa.deploy.internal.derby.DerbyDatabaseInstanceUnit;

/**
 * This is the item provider adapter for a
 * {@link com.ibm.ccl.soa.deploy.internal.derby.DerbyDatabaseInstanceUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DerbyDatabaseInstanceUnitItemProvider extends DatabaseInstanceUnitItemProvider
	 ...
	 * @generated
	 */
	public DerbyDatabaseInstanceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DerbyDatabaseInstanceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerbyDatabaseInstanceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DerbyDatabaseInstanceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DerbyDatabaseInstanceUnit_type") : //$NON-NLS-1$
			getString("_UI_DerbyDatabaseInstanceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
