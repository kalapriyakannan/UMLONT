...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.server.ServerUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ServerUnitItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public ServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ServerUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ServerUnit_type") : //$NON-NLS-1$
				getString("_UI_ServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
