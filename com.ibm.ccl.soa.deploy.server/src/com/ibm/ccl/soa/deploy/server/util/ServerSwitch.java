...
public class ServerSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case ServerPackage.SERVER: {
			...
			if (result == null)
				result = caseCapability(server);
			if (result == null)
				result = caseDeployModelObject(server);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ServerPackage.SERVER_ROOT: {
			ServerRoot serverRoot = (ServerRoot) theEObject;
			Object result = caseServerRoot(serverRoot);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ServerPackage.SERVER_UNIT: {
			ServerUnit serverUnit = (ServerUnit) theEObject;
			Object result = caseServerUnit(serverUnit);
			if (result == null)
				result = caseUnit(serverUnit);
			if (result == null)
				result = caseDeployModelObject(serverUnit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
