...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.TaskContainerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskContainerUnitItemProvider
	 ...
	 * @generated
	 */
	public TaskContainerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TaskContainerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskContainerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TaskContainerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TaskContainerUnit_type") : //$NON-NLS-1$
			getString("_UI_TaskContainerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
