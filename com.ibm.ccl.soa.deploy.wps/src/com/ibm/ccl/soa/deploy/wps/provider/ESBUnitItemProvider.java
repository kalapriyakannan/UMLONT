...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.ESBUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ESBUnitItemProvider
	 ...
	 * @generated
	 */
	public ESBUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ESBUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ESBUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ESBUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ESBUnit_type") : //$NON-NLS-1$
			getString("_UI_ESBUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
