...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.SIBUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SIBUnitItemProvider
	 ...
	 * @generated
	 */
	public SIBUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SIBUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SIBUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SIBUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SIBUnit_type") : //$NON-NLS-1$
			getString("_UI_SIBUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
