...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.BPEContainerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPEContainerUnitItemProvider
	 ...
	 * @generated
	 */
	public BPEContainerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns BPEContainerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BPEContainerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((BPEContainerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BPEContainerUnit_type") : //$NON-NLS-1$
			getString("_UI_BPEContainerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
