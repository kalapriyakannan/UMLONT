...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.WPSSIBUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WPSSIBUnitItemProvider
	 ...
	 * @generated
	 */
	public WPSSIBUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WPSSIBUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WPSSIBUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WPSSIBUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WPSSIBUnit_type") : //$NON-NLS-1$
			getString("_UI_WPSSIBUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
