...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.WPSESBUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WPSESBUnitItemProvider
	 ...
	 * @generated
	 */
	public WPSESBUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WPSESBUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WPSESBUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WPSESBUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WPSESBUnit_type") : //$NON-NLS-1$
			getString("_UI_WPSESBUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
