...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.BusinessRulesManagerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessRulesManagerUnitItemProvider
	 ...
	 * @generated
	 */
	public BusinessRulesManagerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns BusinessRulesManagerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BusinessRulesManagerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((BusinessRulesManagerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BusinessRulesManagerUnit_type") : //$NON-NLS-1$
			getString("_UI_BusinessRulesManagerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
