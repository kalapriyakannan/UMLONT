...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.WPSCommonEventInfrastructureUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WPSCommonEventInfrastructureUnitItemProvider
	 ...
	 * @generated
	 */
	public WPSCommonEventInfrastructureUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WPSCommonEventInfrastructureUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WPSCommonEventInfrastructureUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WPSCommonEventInfrastructureUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WPSCommonEventInfrastructureUnit_type") : //$NON-NLS-1$
			getString("_UI_WPSCommonEventInfrastructureUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
