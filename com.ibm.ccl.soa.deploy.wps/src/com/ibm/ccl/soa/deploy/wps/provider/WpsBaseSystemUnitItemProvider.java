...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.WpsBaseSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WpsBaseSystemUnitItemProvider
	 ...
	 * @generated
	 */
	public WpsBaseSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WpsBaseSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WpsBaseSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WpsBaseSystemUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WpsBaseSystemUnit_type") : //$NON-NLS-1$
			getString("_UI_WpsBaseSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
