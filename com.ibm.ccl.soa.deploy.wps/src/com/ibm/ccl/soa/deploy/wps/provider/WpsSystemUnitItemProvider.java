...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.wps.WpsSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WpsSystemUnitItemProvider
	 ...
	 * @generated
	 */
	public WpsSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WpsSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WpsSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WpsSystemUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WpsSystemUnit_type") : //$NON-NLS-1$
			getString("_UI_WpsSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
