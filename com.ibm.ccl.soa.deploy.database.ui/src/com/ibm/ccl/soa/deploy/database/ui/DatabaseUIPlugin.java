 ...
 */
public class DatabaseUIPlugin extends AbstractUIPlugin {
	/**
	 * The unique identifier for the RadUI plugin.
	 */
	public static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.database.ui"; //$NON-NLS-1$

	//The shared instance.
	private static DatabaseUIPlugin instance;

	/**
	 * The constructor.
	 */
	public DatabaseUIPlugin() {
		instance = this;
	}
	 ...
	 */
	public static DatabaseUIPlugin getDefault() {
		return instance;
	}
