 ...
 * 
 */
public class UMLDeployActionProvider extends CommonActionProvider {
	private IStructuredSelection selection;
	private UmlVizualizeActionGroup umlVizualizeActionGroup;
	...
	public void init(ICommonActionExtensionSite aConfig) {
		...
		if (workbenchSite != null) {
			...
			umlVizualizeActionGroup = new UmlVizualizeActionGroup(viewSite);
	...
	public void dispose() {
		if (isInitialized) {
			...
			umlVizualizeActionGroup.dispose();
	...
	public void setContext(ActionContext aContext) {
		...
		if (isInitialized) {
			if (aContext.getSelection() instanceof IStructuredSelection) {
				...
				umlVizualizeActionGroup.setSelection(selection);
	...
	public void fillContextMenu(IMenuManager aMenu) {
		if (isInitialized) {
			...
			umlVizualizeActionGroup.fillContextMenu(aMenu);
...
//			theActionBars.setGlobalActionHandler(ICommonActionConstants.OPEN, )
			...
			umlVizualizeActionGroup.fillActionBars(theActionBars);
