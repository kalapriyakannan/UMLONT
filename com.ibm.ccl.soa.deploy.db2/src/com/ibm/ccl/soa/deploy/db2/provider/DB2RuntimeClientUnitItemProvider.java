...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2RuntimeClientUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2RuntimeClientUnitItemProvider extends DB2BaseClientUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2RuntimeClientUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2RuntimeClientUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2RuntimeClientUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2RuntimeClientUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2RuntimeClientUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2RuntimeClientUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
