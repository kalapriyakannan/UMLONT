...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.db2.DB2System}. This doesn't
...
public interface DB2SystemValidator {
	...
	boolean validateDb2ProductLang(String value);

	boolean validateDb2Version(String value);

	boolean validateInstallDir(String value);
}
