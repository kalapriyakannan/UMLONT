...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.db2.UnixDB2AdminServer}. This
...
public interface UnixDB2AdminServerValidator {
	...
	boolean validateDasGID(String value);

	boolean validateDasGroupName(String value);

	boolean validateDasUID(String value);

	boolean validateDasUserName(String value);

	boolean validateDasUserPassword(String value);
}
