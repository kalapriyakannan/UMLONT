...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.db2.WindowsDB2System}. This
...
public interface WindowsDB2SystemValidator {
	...
	boolean validateAdminGroupName(String value);

	boolean validateExtendedSecurity(boolean value);

	boolean validateUserGroupName(String value);
}
