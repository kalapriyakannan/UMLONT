...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2AppDevelClientUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2AppDevelClientUnitItemProvider extends DB2BaseClientUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2AppDevelClientUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2AppDevelClientUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2AppDevelClientUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2AppDevelClientUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2AppDevelClientUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2AppDevelClientUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
