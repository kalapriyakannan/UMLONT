...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.db2.WindowsDB2AdminServer}. This
 ...
 */
public interface WindowsDB2AdminServerValidator {
	boolean validate();

	boolean validateDasDomain(String value);
}
