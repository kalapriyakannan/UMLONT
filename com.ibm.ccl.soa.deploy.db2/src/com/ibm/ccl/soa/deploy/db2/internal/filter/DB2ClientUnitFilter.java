...
/**
 * DB2ClientUnitFilter suggests {@link Unit} types to be hosted by an {@link DB2BaseClientUnit}.
 * 
 * @since 3.2
 * 
 */
public class DB2ClientUnitFilter extends UnitFilter {

	private static final List<String> conceptualHostees = Collections
			.singletonList(IDb2TemplateConstants.DB2_CLIENT_INSTANCE_UNIT_CONCEPTUAL);
	private static final List<String> hostees = Collections
			.singletonList(IDb2TemplateConstants.DB2_CLIENT_INSTANCE_UNIT);
