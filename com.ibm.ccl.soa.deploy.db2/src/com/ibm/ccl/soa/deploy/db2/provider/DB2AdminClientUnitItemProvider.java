...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2AdminClientUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2AdminClientUnitItemProvider extends DB2BaseClientUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2AdminClientUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2AdminClientUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2AdminClientUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2AdminClientUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2AdminClientUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2AdminClientUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
