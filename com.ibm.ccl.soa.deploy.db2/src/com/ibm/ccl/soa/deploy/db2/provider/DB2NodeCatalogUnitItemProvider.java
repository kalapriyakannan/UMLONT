...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2NodeCatalogUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2NodeCatalogUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2NodeCatalogUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2NodeCatalogUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2NodeCatalogUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2NodeCatalogUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2NodeCatalogUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2NodeCatalogUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
