...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Windows DB2 Instance</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#isDefaultInstance <em>Default Instance</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#getInstanceType <em>Instance Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.db2.Db2Package#getWindowsDB2Instance()
 * @model extendedMetaData="name='WindowsDB2Instance' kind='elementOnly'"
 * @generated
 */
public interface WindowsDB2Instance extends DB2Instance {
	/**
	 ...
	 * @see com.ibm.ccl.soa.deploy.db2.Db2Package#getWindowsDB2Instance_DefaultInstance()
	...
	/**
	 * Sets the value of the '{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#isDefaultInstance <em>Default Instance</em>}' attribute.
	...
	/**
	 * Unsets the value of the '{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#isDefaultInstance <em>Default Instance</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetDefaultInstance()
	 * @see #isDefaultInstance()
	 * @see #setDefaultInstance(boolean)
	...
	/**
	 * Returns whether the value of the '{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#isDefaultInstance <em>Default Instance</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * @see com.ibm.ccl.soa.deploy.db2.Db2Package#getWindowsDB2Instance_InstanceType()
	...
	/**
	 * Sets the value of the '{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#getInstanceType <em>Instance Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#getInstanceType <em>Instance Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetInstanceType()
	 * @see #getInstanceType()
	 * @see #setInstanceType(WindowsInstanceTypeType)
	...
	/**
	 * Returns whether the value of the '{@link com.ibm.ccl.soa.deploy.db2.WindowsDB2Instance#getInstanceType <em>Instance Type</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
