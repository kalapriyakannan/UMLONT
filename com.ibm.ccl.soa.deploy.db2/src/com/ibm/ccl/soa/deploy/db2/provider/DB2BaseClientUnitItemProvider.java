...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2BaseClientUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2BaseClientUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2BaseClientUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2BaseClientUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2BaseClientUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2BaseClientUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2BaseClientUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2BaseClientUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
