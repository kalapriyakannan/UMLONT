...
/**
 * This is the central singleton for the DB2 edit plugin.
 * 
 * @author Ed Snible <snible@us.ibm.com>
 */
public final class DB2DeployPlugin extends Plugin {
	public final static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.db2"; //$NON-NLS-1$

	//The shared instance.
	private static DB2DeployPlugin plugin;

	/**
	 * Default constructor.
	 */
	public DB2DeployPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static DB2DeployPlugin getDefault() {
		return plugin;
	}
