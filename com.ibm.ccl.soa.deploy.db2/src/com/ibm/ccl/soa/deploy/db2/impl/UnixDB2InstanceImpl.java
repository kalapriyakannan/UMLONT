...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Unix DB2 Instance</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getAuthenticationType <em>Authentication Type</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getFencedGID <em>Fenced GID</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getFencedGroupName <em>Fenced Group Name</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getFencedUID <em>Fenced UID</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getFencedUserName <em>Fenced User Name</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getFencedUserPassword <em>Fenced User Password</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getGID <em>GID</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getGroupName <em>Group Name</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getInstanceType <em>Instance Type</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getUID <em>UID</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.UnixDB2InstanceImpl#getWordWidth <em>Word Width</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UnixDB2InstanceImpl extends DB2InstanceImpl implements UnixDB2Instance {
	/**
	...
	protected EClass eStaticClass() {
		return Db2Package.Literals.UNIX_DB2_INSTANCE;
	}
	...
	public void setAuthenticationType(AuthenticationTypeType newAuthenticationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__AUTHENTICATION_TYPE, oldAuthenticationType, authenticationType, !oldAuthenticationTypeESet));
	}
	...
	public void unsetAuthenticationType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Db2Package.UNIX_DB2_INSTANCE__AUTHENTICATION_TYPE, oldAuthenticationType, AUTHENTICATION_TYPE_EDEFAULT, oldAuthenticationTypeESet));
	}
	...
	public void setFencedGID(String newFencedGID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__FENCED_GID, oldFencedGID, fencedGID));
	}
	...
	public void setFencedGroupName(String newFencedGroupName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__FENCED_GROUP_NAME, oldFencedGroupName, fencedGroupName));
	}
	...
	public void setFencedUID(String newFencedUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__FENCED_UID, oldFencedUID, fencedUID));
	}
	...
	public void setFencedUserName(String newFencedUserName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__FENCED_USER_NAME, oldFencedUserName, fencedUserName));
	}
	...
	public void setFencedUserPassword(String newFencedUserPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__FENCED_USER_PASSWORD, oldFencedUserPassword, fencedUserPassword));
	}
	...
	public void setGID(String newGID) {
		...
		gID = newGID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__GID, oldGID, gID));
	}
	...
	public void setGroupName(String newGroupName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__GROUP_NAME, oldGroupName, groupName));
	}
	...
	public void setInstanceType(UnixInstanceTypeType newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__INSTANCE_TYPE, oldInstanceType, instanceType, !oldInstanceTypeESet));
	}
	...
	public void unsetInstanceType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Db2Package.UNIX_DB2_INSTANCE__INSTANCE_TYPE, oldInstanceType, INSTANCE_TYPE_EDEFAULT, oldInstanceTypeESet));
	}
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__UID, oldUID, uID));
	}
	...
	public void setWordWidth(WordWidthType newWordWidth) {
		...
		wordWidthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.UNIX_DB2_INSTANCE__WORD_WIDTH, oldWordWidth, wordWidth, !oldWordWidthESet));
	}
	...
	public void unsetWordWidth() {
		...
		wordWidthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Db2Package.UNIX_DB2_INSTANCE__WORD_WIDTH, oldWordWidth, WORD_WIDTH_EDEFAULT, oldWordWidthESet));
	}
