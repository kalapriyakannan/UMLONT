...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2DatabaseUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2DatabaseUnitItemProvider extends DatabaseUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2DatabaseUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2DatabaseUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2DatabaseUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2DatabaseUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2DatabaseUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2DatabaseUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
