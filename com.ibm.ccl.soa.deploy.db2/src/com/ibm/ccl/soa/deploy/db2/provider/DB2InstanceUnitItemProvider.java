...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2InstanceUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2InstanceUnitItemProvider extends DatabaseInstanceUnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2InstanceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2InstanceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2InstanceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2InstanceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2InstanceUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2InstanceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
