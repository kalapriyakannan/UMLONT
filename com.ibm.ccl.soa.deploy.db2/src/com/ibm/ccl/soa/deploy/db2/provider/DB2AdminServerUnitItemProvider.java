...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2.DB2AdminServerUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DB2AdminServerUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public DB2AdminServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2AdminServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2AdminServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2AdminServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2AdminServerUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2AdminServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
