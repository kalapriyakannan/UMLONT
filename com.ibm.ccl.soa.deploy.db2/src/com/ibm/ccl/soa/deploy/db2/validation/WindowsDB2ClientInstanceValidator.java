...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.db2.WindowsDB2ClientInstance}.
 ...
 */
public interface WindowsDB2ClientInstanceValidator {
	boolean validate();

	boolean validateDefaultInstance(boolean value);

	boolean validateInstanceType(WindowsInstanceTypeType value);
}
