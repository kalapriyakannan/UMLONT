...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Windows DB2 Client Instance</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.WindowsDB2ClientInstanceImpl#isDefaultInstance <em>Default Instance</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2.impl.WindowsDB2ClientInstanceImpl#getInstanceType <em>Instance Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WindowsDB2ClientInstanceImpl extends DB2ClientInstanceImpl implements
	 ...
	 * @generated
	 */
	protected WindowsDB2ClientInstanceImpl() {
		super();
	}
	...
	public void setDefaultInstance(boolean newDefaultInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.WINDOWS_DB2_CLIENT_INSTANCE__DEFAULT_INSTANCE, oldDefaultInstance, defaultInstance, !oldDefaultInstanceESet));
	}
	...
	public void unsetDefaultInstance() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Db2Package.WINDOWS_DB2_CLIENT_INSTANCE__DEFAULT_INSTANCE, oldDefaultInstance, DEFAULT_INSTANCE_EDEFAULT, oldDefaultInstanceESet));
	}
	...
	public void setInstanceType(WindowsInstanceTypeType newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2Package.WINDOWS_DB2_CLIENT_INSTANCE__INSTANCE_TYPE, oldInstanceType, instanceType, !oldInstanceTypeESet));
	}
	...
	public void unsetInstanceType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Db2Package.WINDOWS_DB2_CLIENT_INSTANCE__INSTANCE_TYPE, oldInstanceType, INSTANCE_TYPE_EDEFAULT, oldInstanceTypeESet));
	}
