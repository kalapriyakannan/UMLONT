 ...
 * </copyright>
 *
 * $Id: LocationUnitItemProvider.java,v 1.1 2007/09/25 19:55:06 chadh Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.analysis.LocationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationUnitItemProvider
	 ...
	 * @generated
	 */
	public LocationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LocationUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LocationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LocationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LocationUnit_type") : //$NON-NLS-1$
			getString("_UI_LocationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
