...
public class AvailabilityConstraintValidator extends ConstraintValidator {
	...
	public boolean canValidateConstraint(Constraint constraint) {
		return AnalysisPackage.Literals.AVAILABILITY_CONSTRAINT.isSuperTypeOf(constraint
				.getEObject().eClass());
	}
	...
	public IStatus validate(Constraint constraint, DeployModelObject context,
		...
		if (!AnalysisPackage.Literals.AVAILABILITY_CONSTRAINT.isSuperTypeOf(constraint
				.getEObject().eClass())) {
...
/*		// we know that it is a AvailabilityConstraint
	...
	public String title(Constraint constraint) {
		AvailabilityConstraint ac = (AvailabilityConstraint) constraint;		
		return AnalysisMessages.bind(AnalysisMessages.REQUIRED_AVAILABILITY_TITLE, computeCaptionTitle(ac),ac.getPercentage());
	}
