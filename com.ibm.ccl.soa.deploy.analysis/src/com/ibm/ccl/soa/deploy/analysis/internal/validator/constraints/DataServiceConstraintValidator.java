...
public class DataServiceConstraintValidator extends ConstraintValidator {

	public DataServiceConstraintValidator() {
	...
	public boolean canValidateConstraint(Constraint constraint) {
		return AnalysisPackage.Literals.DATA_SERVICE_CONSTRAINT.isSuperTypeOf(constraint
				.getEObject().eClass());
	}
	...
	public IStatus validate(Constraint constraint, DeployModelObject context,
		...
		if (!AnalysisPackage.Literals.DATA_SERVICE_CONSTRAINT.isSuperTypeOf(constraint
				.getEObject().eClass())) {
	...
	public String title(Constraint constraint) {
		DataServiceConstraint ac = (DataServiceConstraint) constraint;		
		return AnalysisMessages.bind(AnalysisMessages.DATA_SERVICE_CONSTRAINT, computeCaptionTitle(ac),String.valueOf(ac.getType().getLiteral()));		
	}
