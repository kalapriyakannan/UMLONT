 ...
 * </copyright>
 *
 * $Id: NodeUnitItemProvider.java,v 1.3 2007/12/13 17:55:28 nmakin Exp $
 */
...
import com.ibm.ccl.soa.deploy.core.provider.ConceptualNodeItemProvider;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.analysis.NodeUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeUnitItemProvider
	extends ConceptualNodeItemProvider
	implements	
	 ...
	 * @generated
	 */
	public NodeUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns NodeUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NodeUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((NodeUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NodeUnit_type") : //$NON-NLS-1$
			getString("_UI_NodeUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
