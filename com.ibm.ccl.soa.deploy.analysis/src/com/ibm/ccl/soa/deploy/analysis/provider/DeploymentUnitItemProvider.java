 ...
 * </copyright>
 *
 * $Id: DeploymentUnitItemProvider.java,v 1.3 2007/12/13 17:55:28 nmakin Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.analysis.DeploymentUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentUnitItemProvider
	 ...
	 * @generated
	 */
	public DeploymentUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DeploymentUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeploymentUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DeploymentUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DeploymentUnit_type") : //$NON-NLS-1$
			getString("_UI_DeploymentUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
