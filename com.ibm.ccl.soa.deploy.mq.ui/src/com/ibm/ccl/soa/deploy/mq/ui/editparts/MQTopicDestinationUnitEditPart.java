 ...
 */
public class MQTopicDestinationUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQTopicDestinationUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQTopicDestination"); //$NON-NLS-1$ 
	}
