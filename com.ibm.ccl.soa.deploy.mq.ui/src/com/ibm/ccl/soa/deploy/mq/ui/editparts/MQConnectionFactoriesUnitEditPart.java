 ...
 */
public class MQConnectionFactoriesUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQConnectionFactoriesUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQConnectionFactories"); //$NON-NLS-1$ 
	}
