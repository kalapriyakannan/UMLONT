 ...
 */
public class MQQueueConnectionFactoryUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQQueueConnectionFactoryUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQQueueConnectionFactory"); //$NON-NLS-1$ 
	}
