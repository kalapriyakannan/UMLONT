 ...
 */
public class MQActivationSpecificationUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQActivationSpecificationUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQActivationSpecification"); //$NON-NLS-1$ 
	}
