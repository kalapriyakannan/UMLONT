 ...
 */
public class MQQueueDestinationUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQQueueDestinationUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQQueueDestination"); //$NON-NLS-1$ 
	}
