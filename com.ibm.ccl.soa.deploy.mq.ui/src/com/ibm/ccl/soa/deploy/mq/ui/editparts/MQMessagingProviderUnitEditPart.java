 ...
 */
public class MQMessagingProviderUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQMessagingProviderUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQMessagingProvider"); //$NON-NLS-1$ 
	}
