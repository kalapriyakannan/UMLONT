 ...
 */
public class MQTopicConnectionFactoryUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQTopicConnectionFactoryUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQTopicConnectionFactory"); //$NON-NLS-1$ 
	}
