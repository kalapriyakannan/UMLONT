 ...
 */
public class MQMessageListnerServicePortUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public MQMessageListnerServicePortUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("MQMessageListnerServicePort"); //$NON-NLS-1$ 
	}
