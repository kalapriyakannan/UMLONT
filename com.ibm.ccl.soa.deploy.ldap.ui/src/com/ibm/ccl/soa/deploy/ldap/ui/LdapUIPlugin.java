 ...
 */
public class LdapUIPlugin extends AbstractUIPlugin {
	/**
	 * The unique identifier for the RadUI plugin.
	 */
	public static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.ldap.ui"; //$NON-NLS-1$

	//The shared instance.
	private static LdapUIPlugin instance;
	 ...
	 */
	public static LdapUIPlugin getDefault() {
		return instance;
	}
