...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SCA Implementation BPEL</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.SCAImplementationBPELImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.SCAImplementationBPELImpl#getPolicySets <em>Policy Sets</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.SCAImplementationBPELImpl#getRequires <em>Requires</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SCAImplementationBPELImpl extends CapabilityImpl implements SCAImplementationBPEL {
	/**
	 ...
	 * @generated
	 */
	protected SCAImplementationBPELImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ScaPackage.Literals.SCA_IMPLEMENTATION_BPEL;
	}
	...
	public void setClass(String newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_IMPLEMENTATION_BPEL__CLASS, oldClass, class_));
	}
	...
	public void setPolicySets(String newPolicySets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_IMPLEMENTATION_BPEL__POLICY_SETS, oldPolicySets, policySets));
	}
	...
	public void setRequires(String newRequires) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_IMPLEMENTATION_BPEL__REQUIRES, oldRequires, requires));
	}
