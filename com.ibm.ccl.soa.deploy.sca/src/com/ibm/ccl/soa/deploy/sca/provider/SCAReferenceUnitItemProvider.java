...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAReferenceUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAReferenceUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAReferenceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAReferenceUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAReferenceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAReferenceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAReferenceUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAReferenceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
