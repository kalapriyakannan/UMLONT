...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAImplementationCplusplusUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAImplementationCplusplusUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAImplementationCplusplusUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAImplementationCplusplusUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAImplementationCplusplusUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAImplementationCplusplusUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAImplementationCplusplusUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAImplementationCplusplusUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
