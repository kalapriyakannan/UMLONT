...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAPropertyUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAPropertyUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAPropertyUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAPropertyUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAPropertyUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAPropertyUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAPropertyUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAPropertyUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
