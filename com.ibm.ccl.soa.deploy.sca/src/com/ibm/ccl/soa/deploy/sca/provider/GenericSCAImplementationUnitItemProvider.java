...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.GenericSCAImplementationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenericSCAImplementationUnitItemProvider
	 ...
	 * @generated
	 */
	public GenericSCAImplementationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenericSCAImplementationUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericSCAImplementationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((GenericSCAImplementationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GenericSCAImplementationUnit_type") : //$NON-NLS-1$
			getString("_UI_GenericSCAImplementationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
