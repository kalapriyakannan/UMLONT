...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAComponentUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAComponentUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAComponentUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAComponentUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAComponentUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAComponentUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAComponentUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAComponentUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
