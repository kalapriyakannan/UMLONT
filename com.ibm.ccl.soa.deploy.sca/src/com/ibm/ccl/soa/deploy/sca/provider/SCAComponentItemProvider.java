...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAComponentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SCAComponent_autowire_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SCAComponent_autowire_feature", "_UI_SCAComponent_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ScaPackage.Literals.SCA_COMPONENT__AUTOWIRE,
				 true,
				 false,
				 false,
	...
	protected void addName1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SCAComponent_name1_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SCAComponent_name1_feature", "_UI_SCAComponent_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ScaPackage.Literals.SCA_COMPONENT__NAME1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAComponent")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SCAComponent_type") : //$NON-NLS-1$
			getString("_UI_SCAComponent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
