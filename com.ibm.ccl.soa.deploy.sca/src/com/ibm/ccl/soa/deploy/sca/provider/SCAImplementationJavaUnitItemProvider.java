...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAImplementationJavaUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAImplementationJavaUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAImplementationJavaUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAImplementationJavaUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAImplementationJavaUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAImplementationJavaUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAImplementationJavaUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAImplementationJavaUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
