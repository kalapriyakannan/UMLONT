...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAImplementationBPELUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAImplementationBPELUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAImplementationBPELUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAImplementationBPELUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAImplementationBPELUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAImplementationBPELUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAImplementationBPELUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAImplementationBPELUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
