...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAImplementationCompositeUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAImplementationCompositeUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAImplementationCompositeUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAImplementationCompositeUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAImplementationCompositeUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAImplementationCompositeUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAImplementationCompositeUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAImplementationCompositeUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
