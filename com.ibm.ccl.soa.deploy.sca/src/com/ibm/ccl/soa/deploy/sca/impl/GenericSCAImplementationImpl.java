...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Generic SCA Implementation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.GenericSCAImplementationImpl#getName1 <em>Name1</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.GenericSCAImplementationImpl#getPolicySets <em>Policy Sets</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.GenericSCAImplementationImpl#getRequires <em>Requires</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.GenericSCAImplementationImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GenericSCAImplementationImpl extends CapabilityImpl implements GenericSCAImplementation {
	/**
	 ...
	 * @generated
	 */
	protected GenericSCAImplementationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ScaPackage.Literals.GENERIC_SCA_IMPLEMENTATION;
	}
	...
	public void setName1(String newName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.GENERIC_SCA_IMPLEMENTATION__NAME1, oldName1, name1));
	}
	...
	public void setPolicySets(String newPolicySets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.GENERIC_SCA_IMPLEMENTATION__POLICY_SETS, oldPolicySets, policySets));
	}
	...
	public void setRequires(String newRequires) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.GENERIC_SCA_IMPLEMENTATION__REQUIRES, oldRequires, requires));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.GENERIC_SCA_IMPLEMENTATION__TYPE, oldType, type));
	}
