...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAPolicyIntentUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAPolicyIntentUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAPolicyIntentUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAPolicyIntentUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAPolicyIntentUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAPolicyIntentUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAPolicyIntentUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAPolicyIntentUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
