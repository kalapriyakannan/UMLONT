...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAPropertyValueUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAPropertyValueUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAPropertyValueUnitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SCAPropertyValueUnit_name1_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SCAPropertyValueUnit_name1_feature", "_UI_SCAPropertyValueUnit_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ScaPackage.Literals.SCA_PROPERTY_VALUE_UNIT__NAME1,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns SCAPropertyValueUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAPropertyValueUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAPropertyValueUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAPropertyValueUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAPropertyValueUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SCAPropertyValueUnit.class)) {
			case ScaPackage.SCA_PROPERTY_VALUE_UNIT__NAME1:
