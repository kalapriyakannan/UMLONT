...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAServiceUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAServiceUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAServiceUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAServiceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAServiceUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
