...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCABindingUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCABindingUnitItemProvider
	 ...
	 * @generated
	 */
	public SCABindingUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCABindingUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCABindingUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCABindingUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCABindingUnit_type") : //$NON-NLS-1$
			getString("_UI_SCABindingUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
