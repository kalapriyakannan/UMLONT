...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAOperationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAOperationUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAOperationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAOperationUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAOperationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAOperationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAOperationUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAOperationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
