...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAInterfaceUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAInterfaceUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAInterfaceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAInterfaceUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAInterfaceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAInterfaceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAInterfaceUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAInterfaceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
