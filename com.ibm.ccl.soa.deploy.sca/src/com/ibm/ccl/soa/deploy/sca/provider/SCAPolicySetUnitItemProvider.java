...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.sca.SCAPolicySetUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SCAPolicySetUnitItemProvider
	 ...
	 * @generated
	 */
	public SCAPolicySetUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SCAPolicySetUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SCAPolicySetUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SCAPolicySetUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SCAPolicySetUnit_type") : //$NON-NLS-1$
			getString("_UI_SCAPolicySetUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
