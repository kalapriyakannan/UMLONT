...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SCA Implementation Cplusplus</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.SCAImplementationCplusplusImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.SCAImplementationCplusplusImpl#getPolicySets <em>Policy Sets</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.sca.impl.SCAImplementationCplusplusImpl#getRequires <em>Requires</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SCAImplementationCplusplusImpl extends CapabilityImpl implements SCAImplementationCplusplus {
	/**
	 ...
	 * @generated
	 */
	protected SCAImplementationCplusplusImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ScaPackage.Literals.SCA_IMPLEMENTATION_CPLUSPLUS;
	}
	...
	public void setClass(String newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_IMPLEMENTATION_CPLUSPLUS__CLASS, oldClass, class_));
	}
	...
	public void setPolicySets(String newPolicySets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_IMPLEMENTATION_CPLUSPLUS__POLICY_SETS, oldPolicySets, policySets));
	}
	...
	public void setRequires(String newRequires) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_IMPLEMENTATION_CPLUSPLUS__REQUIRES, oldRequires, requires));
	}
...
} //SCAImplementationCplusplusImpl
