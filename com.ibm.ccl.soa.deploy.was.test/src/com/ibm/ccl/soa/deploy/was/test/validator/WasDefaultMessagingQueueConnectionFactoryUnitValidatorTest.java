...
import com.ibm.ccl.soa.deploy.was.internal.validator.WasDefaultMessagingQueueConnetionFactoryValidator;

public class WasDefaultMessagingQueueConnectionFactoryUnitValidatorTest extends
		TopologyTestCase {

	private static final String PROJECT_NAME = "WasDefaultMessagingQueueConnectionFactoryUnitValidatorTest";
	 ...
	 * 
	 */
	public WasDefaultMessagingQueueConnectionFactoryUnitValidatorTest() {
		super(PROJECT_NAME);
	}
	 ...
	 */
	public void testWasDefaultMessagingQueueConnectionFactoryUnitValidator()
		...
		WasDefaultMessagingQueueConnectionFactoryUnit cfUnit = (WasDefaultMessagingQueueConnectionFactoryUnit) ResolutionUtils
				.addFromTemplate(IWasTemplateConstants.WAS_DEFAULT_MESSAGING_QUEUE_CONNECTION_FACTORY_UNIT,
						_top);
		cfUnit.getRequirements();

		cfUnit.getCapabilities();

		WasDefaultMessagingQueueConnetionFactoryValidator validator = new WasDefaultMessagingQueueConnetionFactoryValidator();

		ValidatorTestUtils.assertValidationErrorCount(4, _top, cfUnit,
				_context, _reporter, validator);

		WasDefaultMessagingQueueConnectionFactoryConfiguration cfCap = (WasDefaultMessagingQueueConnectionFactoryConfiguration) ValidatorUtils
				.getCapability(
						cfUnit,
