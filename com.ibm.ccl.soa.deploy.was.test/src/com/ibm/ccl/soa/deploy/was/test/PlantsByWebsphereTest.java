 ...
 */
public class PlantsByWebsphereTest extends TopologyTestCase {
...
// private EJB providedJ2eeService;
	...
	private Requirement j2cAuthRequiredCell;

	private WasCellUnit wasCellUnit;

	private PlantsByWebsphereTest_LDAPOnly ldapTest;

	/** Test case ctor */
	public PlantsByWebsphereTest() {
	...
	public void addPlantsByWebSphereObjects(/* Topology top */) {
		...
		ldapTest = new PlantsByWebsphereTest_LDAPOnly();
	 ...
	 * @throws Exception
	 */
	public void testPlantsLogicalTopologyCreation() throws Exception {
	...
	private void createDeployableModules() {
		...
		j2eeDS = ValidatorTestUtils.createDependencyRequirement(
				...
				"plants data source");
		ValidatorTestUtils.addEqualsConstraint(j2eeDS,
...
//						"jdbc/PlantsBy"));
		...
		ValidatorTestUtils.addEqualsConstraint(ejbContServ,J2eePackage.Literals.EJB_CONTAINER__CONTAINER_VERSION,
...
//						EJBContainerVersion._20_LITERAL));
		...
		ValidatorTestUtils.addEqualsConstraint(j2eeContServ, J2eePackage.Literals.J2EE_CONTAINER__CONTAINER_VERSION,
...
//						J2EEContainerVersion._13_LITERAL));
		...
		ValidatorTestUtils.addEqualsConstraint(requiredJ2eeSecurityRole, J2eePackage.Literals.J2EE_SECURITY_ROLE__ROLE, "SampAdmin");
...
// earMod.getOnlyDependencyCapabilities().add(providedJ2eeContainer);
		...
		ValidatorTestUtils.addEqualsConstraint(servletContReq,
//		ValidatorTestUtils.addEqualsExpression(servletContReq,
		...
		ValidatorTestUtils.addEqualsConstraint(jspContReq,
//		ValidatorTestUtils.addEqualsExpression(jspContReq,
		...
		ValidatorTestUtils.addEqualsConstraint(j2eeContReq,
//		ValidatorTestUtils.addEqualsExpression(j2eeContReq,
		...
		ValidatorTestUtils.addEqualsConstraint(requiredEjb,
...
// webMod.getRequirements().add(requiredEjb);
	...
	private void createConfigUnits() {
		...
		ValidatorTestUtils.addEqualsConstraint(dsRequiredAuth,
...
// dsUnit.getRequirements().add(dsRequiredWasServerService);
		...
		ValidatorTestUtils.addEqualsConstraint(dsRequiredDatabase,
//		ValidatorTestUtils.addEqualsExpression(dsRequiredDatabase,
		...
		j2cAuthRequiredCell = ValidatorTestUtils.createHostingRequirement(
				WasPackage.Literals.WAS_CELL, "j2cAuthRequiredCell");
		j2cAuthUnit.getRequirements().add(j2cAuthRequiredCell);
	...
	private void createServers() {
		...
		was51Server.getCapabilities().add(variableCap);

		Requirement wasNodeReq = ValidatorTestUtils.createHostingRequirement(
				WasPackage.Literals.WAS_NODE, "wasNodeReq");
		was51Server.getRequirements().add(wasNodeReq);

// Requirement wasNodeReq =
// ValidatorTestUtils.createMemberRequirement(WasPackage.Literals.WAS_NODE_UNIT,
// "wasNodeReq");
// was51Server.getRequirements().add(wasNodeReq);

// Requirement wasOsHostingReq =
// ValidatorTestUtils.createHostingRequirement(OsPackage.Literals.OPERATING_SYSTEM,
// "wasOsHostingReq");
// was51Server.getRequirements().add(wasOsHostingReq);
		...
		wasNode.setNodeName("rf11NODE02");
		...
		wasCell.setWasVersion("5.1");
		wasCell.setCellName("Cell");

		wasCellUnit = WasFactory.eINSTANCE.createWasCellUnit();
		wasCellUnit.setName("wasCellUnit");
		top.getUnits().add(wasCellUnit);
		wasCellUnit.getCapabilities().add(wasCell);

		// Hosting requirement (node) for cell
		Requirement wasNodeHostingForCell = ValidatorTestUtils
				.createHostingRequirement(WasPackage.eINSTANCE.getWasNode(),
						"wasNodeHostingForCell");
		wasCellUnit.getRequirements().add(wasNodeHostingForCell);

		// Shared lib container for cell
		WasSharedLibContainer wasSharedLibContainerCell = WasFactory.eINSTANCE
				.createWasSharedLibContainer();
		wasSharedLibContainerCell.setName("wasSharedLibContainerCell");
		wasSharedLibContainerCell.setDisplayName("wasSharedLibContainerCell");
		wasSharedLibContainerCell.setLinkType(CapabilityLinkTypes.ANY_LITERAL);
		wasCellUnit.getCapabilities().add(wasSharedLibContainerCell);

		//
		// add substitutionVaraible Capbality to cell
		//
		WasSubstitutionVariable cell_variableCap = WasFactory.eINSTANCE
				.createWasSubstitutionVariable();
		cell_variableCap.setName("substitutionVariableCapCell");//$NON-NLS-1$
		cell_variableCap.setDisplayName("substitutionVariable_CapabilityCell");//$NON-NLS-1$
		cell_variableCap.setLinkType(CapabilityLinkTypes.ANY_LITERAL);
		wasCellUnit.getCapabilities().add(cell_variableCap);

		// WasConfigurationContainer for cell
		WasConfigurationContainer wasConfigurationContainerCell = WasFactory.eINSTANCE
				.createWasConfigurationContainer();
		wasConfigurationContainerCell.setName("wasConfigurationContainerCell");
		wasConfigurationContainerCell
				.setDisplayName("wasConfigurationContainerCell");
		wasConfigurationContainerCell
				.setLinkType(CapabilityLinkTypes.ANY_LITERAL);
		wasCellUnit.getCapabilities().add(wasConfigurationContainerCell);

		Requirement wasNodeMemberReqCell = ValidatorTestUtils
				.createMemberRequirement(WasPackage.Literals.WAS_NODE_UNIT,
						"wasNodeReq");
		wasCellUnit.getRequirements().add(wasNodeMemberReqCell);
		...
		// add substitutionVaraible Capbality
		//
		WasSubstitutionVariable node_variableCap = WasFactory.eINSTANCE
				.createWasSubstitutionVariable();
		node_variableCap.setName("substitutionVariableCap");//$NON-NLS-1$
		node_variableCap.setDisplayName("substitutionVariable_Capability");//$NON-NLS-1$
		node_variableCap.setLinkType(CapabilityLinkTypes.ANY_LITERAL);
		wasNodeUnit.getCapabilities().add(node_variableCap);
		...
		// Not for WAS 5.1
// Requirement wasNodeGroupUnitReq =
// ValidatorTestUtils.createMemberRequirement(WasPackage.eINSTANCE.getWasNodeGroupUnit(),
// "wasNodeGroupUnitReq");
// wasNodeGroupUnitReq.setUse(RequirementUsage.OPTIONAL_LITERAL);
// wasNodeUnit.getRequirements().add(wasNodeGroupUnitReq);

// Requirement wasAppServerUnitReq =
// ValidatorTestUtils.createMemberRequirement(WasPackage.eINSTANCE.getWebsphereAppServerUnit(),
// "wasAppServerUnitReq");
...
// Requirement wasDeploymentManagerUnitReq =
// ValidatorTestUtils.createMemberRequirement(WasPackage.eINSTANCE.getWasDeploymentManagerUnit(),
...
// wasNodeUnit.getRequirements().add(wasDeploymentManagerUnitReq);
	...
	private void createWindowsSystemStack() {
		...
		ValidatorTestUtils.addEqualsConstraint(requiredWasOperatingSystem, OsPackage.Literals.OPERATING_SYSTEM__OS_TYPE,
...
//						OperatingSystemType.WINDOWS_LITERAL.getLiteral()));
		ValidatorTestUtils.addEqualsConstraint(requiredWasOperatingSystem, OsPackage.Literals.OPERATING_SYSTEM__OS_VERSION,
		"Win2K");
//		requiredWasOperatingSystem.getExpressions().add(
//				Equals.createExpression(
...
//						"Win2K"));
		...
		providedDirectory1 = OsFactory.eINSTANCE.createDirectory();
		providedDirectory1.setName("providedDirectory1");
		providedDirectory1.setLinkType(CapabilityLinkTypes.ANY_LITERAL);
		...
		operatingSystemUnit1.getCapabilities().add(providedDirectory1);
		...
		ValidatorTestUtils.addEqualsConstraint(requiredServer1, ServerPackage.Literals.SERVER__CPU_ARCHITECTURE, "intel");
//		requiredServer1.getExpressions().add(
//				Equals.createExpression(ServerPackage.eINSTANCE
//						.getServer_CpuArchitecture(), "intel"));
		ValidatorTestUtils.addEqualsConstraint(requiredServer1, ServerPackage.Literals.SERVER__CPU_COUNT, BigInteger.valueOf(1));
//		requiredServer1.getExpressions().add(
//				Equals.createExpression(ServerPackage.eINSTANCE
//						.getServer_CpuCount(), BigInteger.valueOf(1)));
	...
	private void createServiceLinks(PlantsByWebsphereTest_DB2Only db2Test,
		...
		// //////////////////////////////////
		// hosting link between J2C authentication and WAS cell
		ValidatorTestUtils.hosts(wasCellUnit, j2cAuthUnit);

		// //////////////////////////////////
		// hosting link between was cell and was node
		...
		authServiceLink.setSource(dsRequiredAuth);
		...
		ValidatorTestUtils.hosts(wasNodeUnit, was51Server);
...
// wasNodeUnit.getMemberLinks().add(serverNodeMemberLink);
		...
		ldapTest.wasSecurityLink.setTarget(ldapTest.providedWasSecurity);
	}
