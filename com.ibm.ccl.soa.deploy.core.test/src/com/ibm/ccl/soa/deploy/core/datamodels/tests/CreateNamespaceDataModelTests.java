...
/**
 * 	Unit tests for {@link  com.ibm.ccl.soa.deploy.core.datamodels.CreateNamespaceDataModel }
 * 
 * <p>
 * Clients should use {@link CreateNamespaceDataModel#createConfiguredOperation()} to create
 * an instance of this operation, configured with the necessary model properties.
 * </p>
 *
 * @see com.ibm.ccl.soa.deploy.core.internal.datamodels.CreateNamespaceDataModelOperation
 * @see com.ibm.ccl.soa.deploy.core.datamodels.CreateNamespaceDataModel 
 */
public class CreateNamespaceDataModelTests extends TestCase {
	...
	public void testOperationWithRequiredProperties() throws Exception {
		...
		CreateNamespaceDataModel typesafeModel = CreateNamespaceDataModel.createModel();		
