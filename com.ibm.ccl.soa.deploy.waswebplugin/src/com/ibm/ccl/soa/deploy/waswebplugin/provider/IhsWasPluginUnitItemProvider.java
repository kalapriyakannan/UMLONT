...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.waswebplugin.IhsWasPluginUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class IhsWasPluginUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public IhsWasPluginUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IhsWasPluginUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IhsWasPluginUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IhsWasPluginUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IhsWasPluginUnit_type") : //$NON-NLS-1$
			getString("_UI_IhsWasPluginUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
