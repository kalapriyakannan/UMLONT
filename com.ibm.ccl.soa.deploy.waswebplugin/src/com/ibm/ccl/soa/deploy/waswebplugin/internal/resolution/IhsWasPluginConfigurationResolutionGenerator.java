 ...
 * {@link IWasWebPluginProblemTypes#IHS_WAS_PLUGIN_MODULE_CONFIGURATION_ERROR}
 */
public class IhsWasPluginConfigurationResolutionGenerator extends DeployResolutionGenerator {
	...
	public IDeployResolution[] getResolutions(IDeployResolutionContext context) {
		return new IDeployResolution[] { new IhsWasPluginConfigurationResolution(context, this) };
	}
	...
	public boolean hasResolutions(IDeployResolutionContext context) {
		...
		return IWasWebPluginProblemTypes.IHS_WAS_PLUGIN_MODULE_CONFIGURATION_ERROR.equals(status
				.getProblemType());
