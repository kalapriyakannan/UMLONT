...
public class OsgiSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OsgiPackage.BUNDLE_CAPABILITY: {
			...
			case OsgiPackage.BUNDLE_COMPONENT: {
				BundleComponent bundleComponent = (BundleComponent)theEObject;
				Object result = caseBundleComponent(bundleComponent);
				if (result == null) result = caseSoftwareComponent(bundleComponent);
				if (result == null) result = caseBaseComponentUnit(bundleComponent);
				if (result == null) result = caseUnit(bundleComponent);
				if (result == null) result = caseDeployModelObject(bundleComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OsgiPackage.EXPORTED_PACKAGE: {
				ExportedPackage exportedPackage = (ExportedPackage)theEObject;
				Object result = caseExportedPackage(exportedPackage);
				if (result == null) result = caseCapability(exportedPackage);
				if (result == null) result = caseDeployModelObject(exportedPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OsgiPackage.LIBRARY: {
				Library library = (Library)theEObject;
				Object result = caseLibrary(library);
				if (result == null) result = caseUnit(library);
				if (result == null) result = caseDeployModelObject(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OsgiPackage.OS_GI_ROOT: {
				OSGiRoot osGiRoot = (OSGiRoot)theEObject;
				Object result = caseOSGiRoot(osGiRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OS Gi Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OS Gi Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
