...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQQueueUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQQueueUnitItemProvider
	 ...
	 * @generated
	 */
	public MQQueueUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQQueueUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQQueueUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQQueueUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQQueueUnit_type") : //$NON-NLS-1$
			getString("_UI_MQQueueUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
