...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQQueueChannelUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQQueueChannelUnitItemProvider
	 ...
	 * @generated
	 */
	public MQQueueChannelUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQQueueChannelUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQQueueChannelUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQQueueChannelUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQQueueChannelUnit_type") : //$NON-NLS-1$
			getString("_UI_MQQueueChannelUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
