...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQQueueManagerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQQueueManagerUnitItemProvider
	 ...
	 * @generated
	 */
	public MQQueueManagerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQQueueManagerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQQueueManagerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQQueueManagerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQQueueManagerUnit_type") : //$NON-NLS-1$
			getString("_UI_MQQueueManagerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
