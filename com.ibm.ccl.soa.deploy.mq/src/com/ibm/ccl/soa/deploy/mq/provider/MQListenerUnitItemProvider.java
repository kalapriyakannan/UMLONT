...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQListenerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQListenerUnitItemProvider
	 ...
	 * @generated
	 */
	public MQListenerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQListenerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQListenerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQListenerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQListenerUnit_type") : //$NON-NLS-1$
			getString("_UI_MQListenerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
