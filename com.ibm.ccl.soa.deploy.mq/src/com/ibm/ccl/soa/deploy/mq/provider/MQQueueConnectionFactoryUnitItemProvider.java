...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQQueueConnectionFactoryUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQQueueConnectionFactoryUnitItemProvider
	 ...
	 * @generated
	 */
	public MQQueueConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQQueueConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQQueueConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQQueueConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQQueueConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_MQQueueConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
