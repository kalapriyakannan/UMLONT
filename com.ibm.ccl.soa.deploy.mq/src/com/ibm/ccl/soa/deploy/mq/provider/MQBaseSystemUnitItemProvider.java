...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQBaseSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQBaseSystemUnitItemProvider
	 ...
	 * @generated
	 */
	public MQBaseSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQBaseSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQBaseSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQBaseSystemUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQBaseSystemUnit_type") : //$NON-NLS-1$
			getString("_UI_MQBaseSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
