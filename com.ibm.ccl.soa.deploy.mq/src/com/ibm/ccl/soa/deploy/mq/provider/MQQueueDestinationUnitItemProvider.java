...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQQueueDestinationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQQueueDestinationUnitItemProvider
	 ...
	 * @generated
	 */
	public MQQueueDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQQueueDestinationUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQQueueDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQQueueDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQQueueDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_MQQueueDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
