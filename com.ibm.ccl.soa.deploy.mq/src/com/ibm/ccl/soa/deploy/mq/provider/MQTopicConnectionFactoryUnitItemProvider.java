...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQTopicConnectionFactoryUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQTopicConnectionFactoryUnitItemProvider
	 ...
	 * @generated
	 */
	public MQTopicConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQTopicConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQTopicConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQTopicConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQTopicConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_MQTopicConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
