...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQActivationSpecificationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQActivationSpecificationUnitItemProvider
	 ...
	 * @generated
	 */
	public MQActivationSpecificationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQActivationSpecificationUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQActivationSpecificationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQActivationSpecificationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQActivationSpecificationUnit_type") : //$NON-NLS-1$
			getString("_UI_MQActivationSpecificationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
