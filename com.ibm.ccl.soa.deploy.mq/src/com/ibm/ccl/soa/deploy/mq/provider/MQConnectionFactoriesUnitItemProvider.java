...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQConnectionFactoriesUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQConnectionFactoriesUnitItemProvider
	 ...
	 * @generated
	 */
	public MQConnectionFactoriesUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQConnectionFactoriesUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQConnectionFactoriesUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQConnectionFactoriesUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQConnectionFactoriesUnit_type") : //$NON-NLS-1$
			getString("_UI_MQConnectionFactoriesUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
