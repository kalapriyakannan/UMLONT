...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQTopicDestinationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQTopicDestinationUnitItemProvider
	 ...
	 * @generated
	 */
	public MQTopicDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQTopicDestinationUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQTopicDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQTopicDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQTopicDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_MQTopicDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
