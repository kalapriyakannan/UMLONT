...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQMessagingProviderUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQMessagingProviderUnitItemProvider
	 ...
	 * @generated
	 */
	public MQMessagingProviderUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQMessagingProviderUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQMessagingProviderUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQMessagingProviderUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQMessagingProviderUnit_type") : //$NON-NLS-1$
			getString("_UI_MQMessagingProviderUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
