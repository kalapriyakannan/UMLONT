...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.mq.MQMessageListnerServicePortUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MQMessageListnerServicePortUnitItemProvider
	 ...
	 * @generated
	 */
	public MQMessageListnerServicePortUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MQMessageListnerServicePortUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MQMessageListnerServicePortUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MQMessageListnerServicePortUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MQMessageListnerServicePortUnit_type") : //$NON-NLS-1$
			getString("_UI_MQMessageListnerServicePortUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
