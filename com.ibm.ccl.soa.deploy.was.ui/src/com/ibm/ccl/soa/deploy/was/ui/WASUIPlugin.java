 ...
 *******************************************************************************/
package com.ibm.ccl.soa.deploy.was.ui;
 ...
 */
public class WASUIPlugin extends AbstractUIPlugin {
	/**
	 * The unique identifier for the RadUI plugin.
	 */
	public static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.was.ui"; //$NON-NLS-1$

	//The shared instance.
	private static WASUIPlugin instance;
	 ...
	 */
	public static WASUIPlugin getDefault() {
		return instance;
	}
