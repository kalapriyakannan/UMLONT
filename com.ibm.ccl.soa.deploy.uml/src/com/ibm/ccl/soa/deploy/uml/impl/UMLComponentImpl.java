 ...
 * </copyright>
 *
 * $Id: UMLComponentImpl.java,v 1.5 2007/12/05 21:54:25 chadh Exp $
 */
 ...
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.uml.impl.UMLComponentImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.uml.impl.UMLComponentImpl#isLeaf <em>Leaf</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UMLComponentImpl extends UMLElementCapabilityImpl implements UMLComponent {
	/**
	...
	protected EClass eStaticClass() {
		return UmlPackage.Literals.UML_COMPONENT;
	}
	...
	public void setAbstract(boolean newAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.UML_COMPONENT__ABSTRACT, oldAbstract, abstract_, !oldAbstractESet));
	}
	...
	public void unsetAbstract() {
		...
		abstractESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UmlPackage.UML_COMPONENT__ABSTRACT, oldAbstract, ABSTRACT_EDEFAULT, oldAbstractESet));
	}
	...
	public void setLeaf(boolean newLeaf) {
		...
		leafESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.UML_COMPONENT__LEAF, oldLeaf, leaf, !oldLeafESet));
	}
	...
	public void unsetLeaf() {
		...
		leafESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UmlPackage.UML_COMPONENT__LEAF, oldLeaf, LEAF_EDEFAULT, oldLeafESet));
	}
