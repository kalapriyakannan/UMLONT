 ...
 * </copyright>
 *
 * $Id: UMLActorUnitItemProvider.java,v 1.2 2008/02/05 22:17:44 chadh Exp $
 */
...
import com.ibm.ccl.soa.deploy.core.provider.BaseComponentUnitItemProvider;
import com.ibm.ccl.soa.deploy.uml.UMLActorUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.uml.UMLActorUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLActorUnitItemProvider
	extends BaseComponentUnitItemProvider
	implements	
	 ...
	 * @generated
	 */
	public UMLActorUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UMLActorUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UMLActorUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((UMLActorUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UMLActorUnit_type") : //$NON-NLS-1$
			getString("_UI_UMLActorUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
