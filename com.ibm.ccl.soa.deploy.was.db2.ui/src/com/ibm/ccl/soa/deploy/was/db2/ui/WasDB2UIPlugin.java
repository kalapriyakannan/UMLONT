 ...
 *******************************************************************************/
package com.ibm.ccl.soa.deploy.was.db2.ui;
 ...
 */
public final class WasDB2UIPlugin extends Plugin {
	public final static String pluginID = "com.ibm.ccl.soa.deploy.was.db2.ui"; //$NON-NLS-1$

	//The shared instance.
	private static WasDB2UIPlugin plugin;

	/**
	 * Default constructor.
	 */
	public WasDB2UIPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static WasDB2UIPlugin getDefault() {
		return plugin;
	}
