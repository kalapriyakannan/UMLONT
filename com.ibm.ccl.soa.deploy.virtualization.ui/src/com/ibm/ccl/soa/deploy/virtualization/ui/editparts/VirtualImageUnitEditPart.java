 ...
 */
public class VirtualImageUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VirtualImageUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.VirtualImageUnitEditPart_Virtual_Image); 
	}
