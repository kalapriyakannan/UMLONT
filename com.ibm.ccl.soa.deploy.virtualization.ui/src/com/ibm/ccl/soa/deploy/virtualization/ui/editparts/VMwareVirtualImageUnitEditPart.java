 ...
 */
public class VMwareVirtualImageUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VMwareVirtualImageUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.VMwareVirtualImageUnitEditPart_VMware_Virtual_Image);
	}
