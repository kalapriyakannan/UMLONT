 ...
 */
public class VirtualEthernetNICDefUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VirtualEthernetNICDefUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.VirtualEthernetNICDefUnitEditPart_0);  
	}
