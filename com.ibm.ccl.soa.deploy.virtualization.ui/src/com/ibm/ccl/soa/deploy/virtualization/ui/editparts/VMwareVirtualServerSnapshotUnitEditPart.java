 ...
 */
public class VMwareVirtualServerSnapshotUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VMwareVirtualServerSnapshotUnitEditPart(View view) {
		super(view);
		setCategory(Messages.VMwareVirtualServerSnapshotUnitEditPart_VMware_Virtual_Server_Snapshot); 
	}
