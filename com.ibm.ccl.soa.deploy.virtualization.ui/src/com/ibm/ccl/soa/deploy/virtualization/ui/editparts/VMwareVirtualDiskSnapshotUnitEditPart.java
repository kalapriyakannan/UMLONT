 ...
 */
public class VMwareVirtualDiskSnapshotUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VMwareVirtualDiskSnapshotUnitEditPart(View view) {
		super(view);
		setCategory(Messages.VMwareVirtualDiskSnapshotUnitEditPart_VMware_Virtual_Disk_Snapshot); 
	}
