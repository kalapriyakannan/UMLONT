 ...
 */
public class XenVirtualDiskDefUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public XenVirtualDiskDefUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.XenVirtualDiskDefUnitEditPart_Xen_Virtual_Disk_Def); 
	}
