 ...
 */
public class VirtualDiskDefUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VirtualDiskDefUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.VirtualDiskDefUnitEditPart_0); 
	}
