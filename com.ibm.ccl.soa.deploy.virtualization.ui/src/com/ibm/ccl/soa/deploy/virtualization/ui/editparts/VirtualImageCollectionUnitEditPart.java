 ...
 */
public class VirtualImageCollectionUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VirtualImageCollectionUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.VirtualImageCollectionUnitEditPart_Virtual_Image_Collection); 
	}
