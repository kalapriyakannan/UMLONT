 ...
 */
public class VMwareVirtualEthernetNICDefUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public VMwareVirtualEthernetNICDefUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.VMwareVirtualEthernetNICDefUnitEditPart_VMware_Virtual_Ethernet_NIC_Def); 
	}
