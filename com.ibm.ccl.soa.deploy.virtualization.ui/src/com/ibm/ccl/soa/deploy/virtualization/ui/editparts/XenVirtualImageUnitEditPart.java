 ...
 */
public class XenVirtualImageUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public XenVirtualImageUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(Messages.XenVirtualImageUnitEditPart_Xen_Virtual_Image); 
	}
