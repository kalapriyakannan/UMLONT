 ...
 */
public class VirtualizationUIPlugin extends AbstractUIPlugin {

	/**
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "com.ibm.ccl.soa.deploy.virtualization.ui"; //$NON-NLS-1$

	// The shared instance
	private static VirtualizationUIPlugin plugin;
	
	/**
	 * The constructor
	 */
	public VirtualizationUIPlugin() {
	}
	 ...
	 */
	public static VirtualizationUIPlugin getDefault() {
		return plugin;
	}
