...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.http.HTTPDeployRoot}. This
...
public interface HTTPDeployRootValidator {
	...
	boolean validateCapabilityHttpServer(HttpServer value);

	boolean validateCapabilityHttpUser(HttpUser value);

	boolean validateUnitHttpUserUnit(HttpUserUnit value);
}
