 ...
 * </copyright>
 *
 * $Id: HttpServerUnitItemProvider.java,v 1.4 2008/05/08 16:11:04 chadh Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.http.HttpServerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HttpServerUnitItemProvider
	 ...
	 * @generated
	 */
	public HttpServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HttpServerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HttpServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((HttpServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HttpServerUnit_type") : //$NON-NLS-1$
			getString("_UI_HttpServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
