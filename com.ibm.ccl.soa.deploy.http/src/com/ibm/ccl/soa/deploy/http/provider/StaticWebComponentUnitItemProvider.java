 ...
 * </copyright>
 *
 * $Id: StaticWebComponentUnitItemProvider.java,v 1.1 2007/12/11 21:48:22 chadh Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.http.StaticWebComponentUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StaticWebComponentUnitItemProvider
	 ...
	 * @generated
	 */
	public StaticWebComponentUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns StaticWebComponentUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StaticWebComponentUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((StaticWebComponentUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StaticWebComponentUnit_type") : //$NON-NLS-1$
			getString("_UI_StaticWebComponentUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
