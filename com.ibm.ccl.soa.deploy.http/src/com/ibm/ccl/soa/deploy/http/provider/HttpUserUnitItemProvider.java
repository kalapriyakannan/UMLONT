...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.http.HttpUserUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class HttpUserUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public HttpUserUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HttpUserUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HttpUserUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((HttpUserUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HttpUserUnit_type") : //$NON-NLS-1$
			getString("_UI_HttpUserUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
