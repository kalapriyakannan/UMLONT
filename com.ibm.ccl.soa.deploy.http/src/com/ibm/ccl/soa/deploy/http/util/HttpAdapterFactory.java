...
public class HttpAdapterFactory extends AdapterFactoryImpl {
	...
	protected HttpSwitch modelSwitch = new HttpSwitch() {
			public Object caseHTTPDeployRoot(HTTPDeployRoot object) {
				return createHTTPDeployRootAdapter();
			}
			...
			public Object caseStaticWebComponent(StaticWebComponent object) {
				return createStaticWebComponentAdapter();
			}
			public Object caseStaticWebComponentUnit(StaticWebComponentUnit object) {
				return createStaticWebComponentUnitAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ibm.ccl.soa.deploy.http.HTTPDeployRoot <em>HTTP Deploy Root</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ibm.ccl.soa.deploy.http.StaticWebComponent <em>Static Web Component</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ibm.ccl.soa.deploy.http.StaticWebComponentUnit <em>Static Web Component Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
