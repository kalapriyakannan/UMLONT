 ...
 *
 * $Id: FileSystemUnitItemProvider.java,v 1.1 2007/12/19 23:37:05 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.FileSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileSystemUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public FileSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns FileSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FileSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((FileSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_FileSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_FileSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
