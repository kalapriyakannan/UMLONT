 ...
 *
 * $Id: SMBFileSystemUnitItemProvider.java,v 1.1 2007/12/19 23:37:04 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.SMBFileSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SMBFileSystemUnitItemProvider extends RemoteFileSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public SMBFileSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SMBFileSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SMBFileSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SMBFileSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_SMBFileSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_SMBFileSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
