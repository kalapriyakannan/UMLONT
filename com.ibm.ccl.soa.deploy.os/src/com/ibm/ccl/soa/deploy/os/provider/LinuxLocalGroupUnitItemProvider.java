...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.LinuxLocalGroupUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LinuxLocalGroupUnitItemProvider extends UserGroupUnitItemProvider implements
	 ...
	 * @generated
	 */
	public LinuxLocalGroupUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LinuxLocalGroupUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinuxLocalGroupUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LinuxLocalGroupUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LinuxLocalGroupUnit_type") : //$NON-NLS-1$
				getString("_UI_LinuxLocalGroupUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
