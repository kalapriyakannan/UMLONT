...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.WindowsLocalUserUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WindowsLocalUserUnitItemProvider extends UserUnitItemProvider implements
	 ...
	 * @generated
	 */
	public WindowsLocalUserUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WindowsLocalUserUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WindowsLocalUserUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WindowsLocalUserUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WindowsLocalUserUnit_type") : //$NON-NLS-1$
				getString("_UI_WindowsLocalUserUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
