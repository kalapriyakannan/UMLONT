...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.AIXLocalServiceUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class AIXLocalServiceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public AIXLocalServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AIXLocalServiceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AIXLocalServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((AIXLocalServiceUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AIXLocalServiceUnit_type") : //$NON-NLS-1$
				getString("_UI_AIXLocalServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
