 ...
 **************************************************************************************************/
package com.ibm.ccl.soa.deploy.os.internal.validator.matcher;
...
/**
 * Domain specific matcher for OS.
 */
public class OsDomainMatcher extends CoreDomainMatcher {

//	private LinkMatcherStrategy hostingLinkMatcherStrategy = new HostingLinkMatcherStrategy(
//			new OsHostingLinkMatcher());
//
	/**
	 * Constructor
	 */
	public OsDomainMatcher() {
