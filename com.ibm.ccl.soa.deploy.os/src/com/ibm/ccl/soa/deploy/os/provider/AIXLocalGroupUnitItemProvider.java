...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.AIXLocalGroupUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class AIXLocalGroupUnitItemProvider extends UserGroupUnitItemProvider implements
	 ...
	 * @generated
	 */
	public AIXLocalGroupUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AIXLocalGroupUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AIXLocalGroupUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((AIXLocalGroupUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AIXLocalGroupUnit_type") : //$NON-NLS-1$
				getString("_UI_AIXLocalGroupUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
