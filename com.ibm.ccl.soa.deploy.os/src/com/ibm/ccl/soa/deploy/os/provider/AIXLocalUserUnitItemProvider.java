...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.AIXLocalUserUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class AIXLocalUserUnitItemProvider extends UserUnitItemProvider implements
	 ...
	 * @generated
	 */
	public AIXLocalUserUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AIXLocalUserUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AIXLocalUserUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((AIXLocalUserUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AIXLocalUserUnit_type") : //$NON-NLS-1$
				getString("_UI_AIXLocalUserUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
