...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.UserGroupUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class UserGroupUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public UserGroupUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UserGroupUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UserGroupUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((UserGroupUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_UserGroupUnit_type") : //$NON-NLS-1$
				getString("_UI_UserGroupUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
