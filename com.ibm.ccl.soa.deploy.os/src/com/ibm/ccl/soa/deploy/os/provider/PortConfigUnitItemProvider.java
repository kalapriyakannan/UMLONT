...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.PortConfigUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class PortConfigUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public PortConfigUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PortConfigUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PortConfigUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((PortConfigUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PortConfigUnit_type") : //$NON-NLS-1$
				getString("_UI_PortConfigUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
