...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.LinuxLocalServiceUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LinuxLocalServiceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public LinuxLocalServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LinuxLocalServiceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinuxLocalServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LinuxLocalServiceUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LinuxLocalServiceUnit_type") : //$NON-NLS-1$
				getString("_UI_LinuxLocalServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
