...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.LinuxLocalUserUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LinuxLocalUserUnitItemProvider extends UserUnitItemProvider implements
	 ...
	 * @generated
	 */
	public LinuxLocalUserUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LinuxLocalUserUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinuxLocalUserUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LinuxLocalUserUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LinuxLocalUserUnit_type") : //$NON-NLS-1$
				getString("_UI_LinuxLocalUserUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
