...
/**
 * This is the central singleton for the Operating System edit plugin.
 * 
 * @author Ed Snible <snible@us.ibm.com>
 */
public final class OsDeployPlugin extends Plugin {
	/** Unique identifier of the OS deploy domain plug-in. */
	public final static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.os"; //$NON-NLS-1$

	//The shared instance.
	private static OsDeployPlugin plugin;

	/**
	 * Default constructor.
	 */
	public OsDeployPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static OsDeployPlugin getDefault() {
		return plugin;
	}
