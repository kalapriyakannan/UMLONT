 ...
 * reserved.
 * 
 * $Id: DirectoryItemProvider.java,v 1.7 2008/04/29 23:04:38 esnible Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.Directory} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DirectoryItemProvider extends FileSystemContentItemProvider implements
	...
	/**
	 * This adds a property descriptor for the Directory Path feature. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDirectoryPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Directory_directoryPath_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Directory_directoryPath_feature", "_UI_Directory_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsPackage.Literals.DIRECTORY__DIRECTORY_PATH, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns Directory.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
