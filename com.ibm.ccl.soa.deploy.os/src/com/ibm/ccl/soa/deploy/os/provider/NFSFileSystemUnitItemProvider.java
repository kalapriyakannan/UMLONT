 ...
 *
 * $Id: NFSFileSystemUnitItemProvider.java,v 1.1 2007/12/19 23:37:04 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.NFSFileSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NFSFileSystemUnitItemProvider extends RemoteFileSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public NFSFileSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns NFSFileSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NFSFileSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((NFSFileSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_NFSFileSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_NFSFileSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
