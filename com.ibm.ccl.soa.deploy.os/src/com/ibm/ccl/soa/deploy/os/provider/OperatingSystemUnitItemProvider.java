...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.OperatingSystemUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class OperatingSystemUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public OperatingSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns OperatingSystemUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperatingSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((OperatingSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_OperatingSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_OperatingSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
