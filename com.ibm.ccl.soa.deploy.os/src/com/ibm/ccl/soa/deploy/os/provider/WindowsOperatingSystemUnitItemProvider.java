...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.WindowsOperatingSystemUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class WindowsOperatingSystemUnitItemProvider extends OperatingSystemUnitItemProvider
	 ...
	 * @generated
	 */
	public WindowsOperatingSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WindowsOperatingSystemUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/WindowsOperatingSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WindowsOperatingSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WindowsOperatingSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_WindowsOperatingSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
