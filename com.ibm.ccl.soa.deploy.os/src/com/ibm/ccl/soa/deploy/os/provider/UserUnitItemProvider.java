...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.UserUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class UserUnitItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public UserUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UserUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UserUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((UserUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_UserUnit_type") : //$NON-NLS-1$
				getString("_UI_UserUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
