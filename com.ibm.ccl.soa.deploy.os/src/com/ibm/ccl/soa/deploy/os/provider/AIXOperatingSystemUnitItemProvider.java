...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.AIXOperatingSystemUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class AIXOperatingSystemUnitItemProvider extends OperatingSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public AIXOperatingSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AIXOperatingSystemUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator()
				.getImage("full/obj16/AIXOperatingSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((AIXOperatingSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AIXOperatingSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_AIXOperatingSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
