 ...
 *
 * $Id: RemoteFileSystemUnitItemProvider.java,v 1.1 2007/12/19 23:37:04 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.RemoteFileSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RemoteFileSystemUnitItemProvider extends FileSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public RemoteFileSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RemoteFileSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RemoteFileSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((RemoteFileSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_RemoteFileSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_RemoteFileSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
