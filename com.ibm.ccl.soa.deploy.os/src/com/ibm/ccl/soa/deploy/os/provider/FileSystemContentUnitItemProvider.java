 ...
 *
 * $Id: FileSystemContentUnitItemProvider.java,v 1.1 2007/12/19 23:37:04 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.FileSystemContentUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileSystemContentUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public FileSystemContentUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns FileSystemContentUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FileSystemContentUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((FileSystemContentUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_FileSystemContentUnit_type") : //$NON-NLS-1$
				getString("_UI_FileSystemContentUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
