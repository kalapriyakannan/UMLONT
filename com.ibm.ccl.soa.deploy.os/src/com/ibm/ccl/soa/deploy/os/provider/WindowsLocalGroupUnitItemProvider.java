...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.WindowsLocalGroupUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WindowsLocalGroupUnitItemProvider extends UserGroupUnitItemProvider implements
	 ...
	 * @generated
	 */
	public WindowsLocalGroupUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WindowsLocalGroupUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WindowsLocalGroupUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WindowsLocalGroupUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WindowsLocalGroupUnit_type") : //$NON-NLS-1$
				getString("_UI_WindowsLocalGroupUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
