...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.WindowsLocalServiceUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class WindowsLocalServiceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public WindowsLocalServiceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WindowsLocalServiceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/WindowsLocalServiceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WindowsLocalServiceUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WindowsLocalServiceUnit_type") : //$NON-NLS-1$
				getString("_UI_WindowsLocalServiceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
