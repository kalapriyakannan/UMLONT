 ...
 *
 * $Id: LocalFileSystemUnitItemProvider.java,v 1.1 2007/12/19 23:37:04 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.LocalFileSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalFileSystemUnitItemProvider extends FileSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public LocalFileSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LocalFileSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LocalFileSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LocalFileSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LocalFileSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_LocalFileSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
