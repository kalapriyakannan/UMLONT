 ...
 *
 * $Id: WindowsFileSystemUnitItemProvider.java,v 1.1 2007/12/19 23:37:05 barnold Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.WindowsFileSystemUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WindowsFileSystemUnitItemProvider extends LocalFileSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public WindowsFileSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns WindowsFileSystemUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WindowsFileSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((WindowsFileSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WindowsFileSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_WindowsFileSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
