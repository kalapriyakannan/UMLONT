...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.os.LinuxOperatingSystemUnit} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class LinuxOperatingSystemUnitItemProvider extends OperatingSystemUnitItemProvider implements
	 ...
	 * @generated
	 */
	public LinuxOperatingSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LinuxOperatingSystemUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/LinuxOperatingSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LinuxOperatingSystemUnit) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LinuxOperatingSystemUnit_type") : //$NON-NLS-1$
				getString("_UI_LinuxOperatingSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
