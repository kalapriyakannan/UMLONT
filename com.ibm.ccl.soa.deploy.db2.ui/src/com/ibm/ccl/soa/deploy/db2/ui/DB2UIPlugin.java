 ...
 *******************************************************************************/
package com.ibm.ccl.soa.deploy.db2.ui;
 ...
 */
public class DB2UIPlugin extends AbstractUIPlugin {
	/**
	 * The unique identifier for the RadUI plugin.
	 */
	public static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.db2.ui"; //$NON-NLS-1$

	//The shared instance.
	private static DB2UIPlugin instance;
	 ...
	 */
	public static DB2UIPlugin getDefault() {
		return instance;
	}
