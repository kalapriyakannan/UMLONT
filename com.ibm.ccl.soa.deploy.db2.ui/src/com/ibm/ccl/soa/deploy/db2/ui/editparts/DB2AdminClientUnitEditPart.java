...
/**
 * EditPart for {@link DB2AdminClientUnit}.
 * 
 ...
 */
public class DB2AdminClientUnitEditPart extends ModuleEditPart {
	/**
	 * @param view
	 */
	public DB2AdminClientUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(DB2EditPartMessages.DB2_Admin_Client);
