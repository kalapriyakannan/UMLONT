...
/**
 * EditPart for {@link DB2AppDevelClientUnit}.
 * 
 ...
 */
public class DB2AppDevelClientUnitEditPart extends ModuleEditPart {
	/**
	 * @param view
	 */
	public DB2AppDevelClientUnitEditPart(View view) {
		super(view);
		// determine figure category description
		setCategory(DB2EditPartMessages.DB2_App_Dev_Client);
