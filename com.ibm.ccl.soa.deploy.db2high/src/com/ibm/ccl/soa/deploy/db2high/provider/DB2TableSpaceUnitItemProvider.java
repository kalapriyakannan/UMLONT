...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2high.DB2TableSpaceUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DB2TableSpaceUnitItemProvider
	 ...
	 * @generated
	 */
	public DB2TableSpaceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2TableSpaceUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2TableSpaceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2TableSpaceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2TableSpaceUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2TableSpaceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
