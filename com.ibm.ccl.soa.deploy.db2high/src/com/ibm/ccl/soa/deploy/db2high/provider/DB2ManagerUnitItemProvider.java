...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2high.DB2ManagerUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DB2ManagerUnitItemProvider
	 ...
	 * @generated
	 */
	public DB2ManagerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2ManagerUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2ManagerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2ManagerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2ManagerUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2ManagerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
