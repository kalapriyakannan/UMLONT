 ...
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2high.impl.DB2IndexImpl#getField <em>Field</em>}</li>
 *   <li>{@link com.ibm.ccl.soa.deploy.db2high.impl.DB2IndexImpl#getName1 <em>Name1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DB2IndexImpl extends CapabilityImpl implements DB2Index {
	/**
	...
	protected EClass eStaticClass() {
		return Db2highPackage.Literals.DB2_INDEX;
	}
	...
	public void setField(String newField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2highPackage.DB2_INDEX__FIELD, oldField, field));
	}
	...
	public void setName1(String newName1) {
		...
		name1 = newName1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Db2highPackage.DB2_INDEX__NAME1, oldName1, name1));
	}
