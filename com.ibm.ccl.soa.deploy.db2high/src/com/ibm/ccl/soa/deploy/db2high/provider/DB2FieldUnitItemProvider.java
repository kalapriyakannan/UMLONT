...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2high.DB2FieldUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DB2FieldUnitItemProvider
	 ...
	 * @generated
	 */
	public DB2FieldUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2FieldUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2FieldUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2FieldUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2FieldUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2FieldUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
