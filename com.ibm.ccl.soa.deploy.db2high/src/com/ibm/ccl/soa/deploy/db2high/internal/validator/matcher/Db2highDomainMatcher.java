 ...
 *******************************************************************************/
package com.ibm.ccl.soa.deploy.db2high.internal.validator.matcher;
...
/**
 * Domain specific matcher for the Db2high package.
 */
public class Db2highDomainMatcher extends CoreDomainMatcher {

	/**
	 * Constructor
	 */
	public Db2highDomainMatcher() {
