...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2high.DB2BufferPoolUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DB2BufferPoolUnitItemProvider
	 ...
	 * @generated
	 */
	public DB2BufferPoolUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2BufferPoolUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2BufferPoolUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2BufferPoolUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2BufferPoolUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2BufferPoolUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
