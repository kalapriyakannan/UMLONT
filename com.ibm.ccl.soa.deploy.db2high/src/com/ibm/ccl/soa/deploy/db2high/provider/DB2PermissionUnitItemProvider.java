...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.db2high.DB2PermissionUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DB2PermissionUnitItemProvider
	 ...
	 * @generated
	 */
	public DB2PermissionUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DB2PermissionUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DB2PermissionUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DB2PermissionUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DB2PermissionUnit_type") : //$NON-NLS-1$
			getString("_UI_DB2PermissionUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
