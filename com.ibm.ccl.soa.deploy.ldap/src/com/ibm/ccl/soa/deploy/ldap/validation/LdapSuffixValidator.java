...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.ldap.LdapSuffix}. This doesn't
 ...
 */
public interface LdapSuffixValidator {
	boolean validate();

	boolean validateSuffixDN(String value);
}
