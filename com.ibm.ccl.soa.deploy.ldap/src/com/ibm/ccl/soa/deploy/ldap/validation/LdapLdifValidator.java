...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.ldap.LdapLdif}. This doesn't
...
public interface LdapLdifValidator {
	...
	boolean validateAction(LdifAction value);

	boolean validateSubtreeDn(String value);
}
