 ...
 * </copyright>
 *
 * $Id: LdapEntryUnitItemProvider.java,v 1.1 2008/06/17 19:59:19 pershng Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.LdapEntryUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LdapEntryUnitItemProvider
	 ...
	 * @generated
	 */
	public LdapEntryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LdapEntryUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LdapEntryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LdapEntryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LdapEntryUnit_type") : //$NON-NLS-1$
			getString("_UI_LdapEntryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
