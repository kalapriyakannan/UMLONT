...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.LdapSchemaUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LdapSchemaUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public LdapSchemaUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LdapSchemaUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LdapSchemaUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LdapSchemaUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LdapSchemaUnit_type") : //$NON-NLS-1$
			getString("_UI_LdapSchemaUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
