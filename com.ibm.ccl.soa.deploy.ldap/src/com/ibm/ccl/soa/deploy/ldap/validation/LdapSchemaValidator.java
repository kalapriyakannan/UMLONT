...
/**
 * A sample validator interface for {@link com.ibm.ccl.soa.deploy.ldap.LdapSchema}. This doesn't
 ...
 */
public interface LdapSchemaValidator {
	boolean validate();

	boolean validateAction(SchemaAction value);
}
