...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.LdapLdifUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LdapLdifUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public LdapLdifUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LdapLdifUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LdapLdifUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LdapLdifUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LdapLdifUnit_type") : //$NON-NLS-1$
			getString("_UI_LdapLdifUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
