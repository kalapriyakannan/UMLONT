...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.LdapClientUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LdapClientUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public LdapClientUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LdapClientUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LdapClientUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LdapClientUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LdapClientUnit_type") : //$NON-NLS-1$
			getString("_UI_LdapClientUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
