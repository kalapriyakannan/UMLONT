...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.SecurityRoleReferenceUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityRoleReferenceUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public SecurityRoleReferenceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SecurityRoleReferenceUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SecurityRoleReferenceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((SecurityRoleReferenceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SecurityRoleReferenceUnit_type") : //$NON-NLS-1$
			getString("_UI_SecurityRoleReferenceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
