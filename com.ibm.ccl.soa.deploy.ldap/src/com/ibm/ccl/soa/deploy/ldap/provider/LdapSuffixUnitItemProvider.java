...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.LdapSuffixUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LdapSuffixUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public LdapSuffixUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LdapSuffixUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LdapSuffixUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LdapSuffixUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LdapSuffixUnit_type") : //$NON-NLS-1$
			getString("_UI_LdapSuffixUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
