...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ldap.LdapServerUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LdapServerUnitItemProvider extends UnitItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public LdapServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LdapServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LdapServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((LdapServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LdapServerUnit_type") : //$NON-NLS-1$
			getString("_UI_LdapServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
