...
public class TdsBaseSystemUnitItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TdsBaseSystemUnit"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TdsBaseSystemUnit_type") :
			getString("_UI_TdsBaseSystemUnit_type") + " " + label;
	}
