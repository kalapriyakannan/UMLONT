 ...
 *******************************************************************************/
package com.ibm.ccl.soa.deploy.tomcat.ui;
...
public class TomcatUIPlugin extends AbstractUIPlugin {
	 ...
	 */
	public static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.tomcat.ui"; //$NON-NLS-1$

	//The shared instance.
	private static TomcatUIPlugin instance;
	 ...
	 */
	public static TomcatUIPlugin getDefault() {
		return instance;
	}
