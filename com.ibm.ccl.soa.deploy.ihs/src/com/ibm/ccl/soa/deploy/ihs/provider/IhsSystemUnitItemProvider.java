...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ihs.IhsSystemUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class IhsSystemUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public IhsSystemUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IhsSystemUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IhsSystemUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IhsSystemUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IhsSystemUnit_type") : //$NON-NLS-1$
			getString("_UI_IhsSystemUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
