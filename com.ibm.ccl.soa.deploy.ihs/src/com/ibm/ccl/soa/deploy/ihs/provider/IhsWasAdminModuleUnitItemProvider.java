...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ihs.IhsWasAdminModuleUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class IhsWasAdminModuleUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public IhsWasAdminModuleUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IhsWasAdminModuleUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IhsWasAdminModuleUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IhsWasAdminModuleUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IhsWasAdminModuleUnit_type") : //$NON-NLS-1$
			getString("_UI_IhsWasAdminModuleUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
