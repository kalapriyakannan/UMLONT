...
import com.ibm.ccl.soa.deploy.http.provider.HttpUserUnitItemProvider;
import com.ibm.ccl.soa.deploy.ihs.IhsUserUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ihs.IhsUserUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class IhsUserUnitItemProvider extends HttpUserUnitItemProvider implements
	 ...
	 * @generated
	 */
	public IhsUserUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IhsUserUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IhsUserUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IhsUserUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IhsUserUnit_type") : //$NON-NLS-1$
			getString("_UI_IhsUserUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
