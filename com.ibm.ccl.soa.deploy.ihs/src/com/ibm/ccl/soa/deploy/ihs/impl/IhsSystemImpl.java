 ...
 * <ul>
 *   <li>{@link com.ibm.ccl.soa.deploy.ihs.impl.IhsSystemImpl#getInstallLocation <em>Install Location</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IhsSystemImpl extends CapabilityImpl implements IhsSystem {
	/**
	...
	protected EClass eStaticClass() {
		return IhsPackage.Literals.IHS_SYSTEM;
	}
	...
	public void setInstallLocation(String newInstallLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IhsPackage.IHS_SYSTEM__INSTALL_LOCATION, oldInstallLocation, installLocation));
	}
