...
/**
 * This is the central singleton for the WAS IHS plugin.
 */
public final class IhsDeployPlugin extends Plugin {
	/** Plugin identifier. */
	public final static String PLUGIN_ID = "com.ibm.ccl.soa.deploy.ihs"; //$NON-NLS-1$

	/** The shared plugin instance. */
	private static IhsDeployPlugin plugin;

	/**
	 * Default constructor.
	 */
	public IhsDeployPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static IhsDeployPlugin getDefault() {
		return plugin;
	}
