...
import com.ibm.ccl.soa.deploy.http.provider.HttpServerUnitItemProvider;
import com.ibm.ccl.soa.deploy.ihs.IhsServerUnit;

/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ihs.IhsServerUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class IhsServerUnitItemProvider extends HttpServerUnitItemProvider implements
	 ...
	 * @generated
	 */
	public IhsServerUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IhsServerUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IhsServerUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IhsServerUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IhsServerUnit_type") : //$NON-NLS-1$
			getString("_UI_IhsServerUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
