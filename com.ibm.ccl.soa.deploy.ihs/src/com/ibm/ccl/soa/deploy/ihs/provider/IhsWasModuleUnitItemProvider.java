...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.ihs.IhsWasModuleUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class IhsWasModuleUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public IhsWasModuleUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IhsWasModuleUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IhsWasModuleUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IhsWasModuleUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IhsWasModuleUnit_type") : //$NON-NLS-1$
			getString("_UI_IhsWasModuleUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
