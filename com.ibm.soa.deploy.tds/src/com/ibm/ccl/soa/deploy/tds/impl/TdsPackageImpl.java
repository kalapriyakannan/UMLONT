...
public class TdsPackageImpl extends EPackageImpl implements TdsPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(tdsBaseSystemEClass, TdsBaseSystem.class, "TdsBaseSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getTdsBaseSystem_InstallLocation(), theXMLTypePackage.getString(), "installLocation", null, 0, 1, TdsBaseSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getTdsBaseSystem_Version(), theXMLTypePackage.getString(), "version", null, 0, 1, TdsBaseSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getTdsBaseSystem_Wonderful(), theXMLTypePackage.getString(), "wonderful", null, 0, 1, TdsBaseSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(tdsBaseSystemUnitEClass, TdsBaseSystemUnit.class, "TdsBaseSystemUnit", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(tdsRootEClass, TDSRoot.class, "TDSRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getTDSRoot_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getTDSRoot_XMLNSPrefixMap(), ecorePackage.getEStringToStringMapEntry(), null, "xMLNSPrefixMap", null, 0, -1, null, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getTDSRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(), null, "xSISchemaLocation", null, 0, -1, null, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getTDSRoot_CapabilityTdsBaseSystem(), this.getTdsBaseSystem(), null, "capabilityTdsBaseSystem", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getTDSRoot_UnitTdsBaseSystemUnit(), this.getTdsBaseSystemUnit(), null, "unitTdsBaseSystemUnit", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (tdsBaseSystemEClass, 
		   source, 
		   new String[] {
			 "name", "TdsBaseSystem", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation
		  (getTdsBaseSystem_Wonderful(), 
		   ...
		   new String[] {
			 "kind", "attribute", //$NON-NLS-1$ //$NON-NLS-2$
			 "name", "wonderful" //$NON-NLS-1$ //$NON-NLS-2$
		   });			
		addAnnotation
		  (tdsBaseSystemUnitEClass, 
		   source, 
		   new String[] {
			 "name", "TdsBaseSystemUnit", //$NON-NLS-1$ //$NON-NLS-2$
			 "kind", "elementOnly" //$NON-NLS-1$ //$NON-NLS-2$
		   });		
		addAnnotation
		  (tdsRootEClass, 
		...
		addAnnotation
		  (getTDSRoot_CapabilityTdsBaseSystem(), 
		   ...
		   new String[] {
			 ...
			 "name", "capability.tdsBaseSystem", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation
		  (getTDSRoot_UnitTdsBaseSystemUnit(), 
		   ...
		   new String[] {
			 "kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
			 "name", "unit.tdsBaseSystemUnit", //$NON-NLS-1$ //$NON-NLS-2$
			 "namespace", "##targetNamespace", //$NON-NLS-1$ //$NON-NLS-2$
