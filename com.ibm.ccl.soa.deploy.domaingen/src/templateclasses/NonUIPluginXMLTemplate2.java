...
public class NonUIPluginXMLTemplate2
{
  ...
  protected final String TEXT_1 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + NL + "<?eclipse version=\"3.0\"?>" + NL + "" + NL + "<!--" + NL + " <copyright>" + NL + " </copyright>" + NL + "" + NL + " $Id: NonUIplugin.xmljet,v 1.1 2008/03/01 18:20:56 barnold Exp $" + NL + "-->" + NL + "" + NL + "<plugin>" + NL + "    " + NL + "  <extension point=\"org.eclipse.emf.edit.itemProviderAdapterFactories\">" + NL + "    <factory " + NL + "       uri = \"";
