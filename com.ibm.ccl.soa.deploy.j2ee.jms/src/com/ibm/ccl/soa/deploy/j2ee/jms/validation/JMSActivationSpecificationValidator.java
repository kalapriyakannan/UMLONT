 ...
 * {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSActivationSpecification}. This doesn't really do
...
public interface JMSActivationSpecificationValidator {
	...
	boolean validateAcknowledgeMode(AcknowledgeModeEnum value);

	boolean validateClientIdentifier(String value);

	boolean validateJndiName(String value);

	boolean validateMesasageSelector(String value);

	boolean validateSpecificationName(String value);

	boolean validateSubscriptionDurable(boolean value);

	boolean validateSubscriptionName(String value);
}
