...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSQueueConnectionFactoryUnit} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class JMSQueueConnectionFactoryUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSQueueConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSQueueConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSQueueConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSQueueConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSQueueConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSQueueConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
