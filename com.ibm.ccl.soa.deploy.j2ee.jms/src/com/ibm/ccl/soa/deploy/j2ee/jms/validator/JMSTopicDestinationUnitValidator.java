...
public class JMSTopicDestinationUnitValidator extends UnitValidator {

	public JMSTopicDestinationUnitValidator() {
		this(JmsPackage.eINSTANCE.getJMSTopicDestinationUnit());
	}

	protected JMSTopicDestinationUnitValidator(EClass unitType) {
		super(unitType);

		addAttributeValidator(new DeployAttributeStringNotEmptyValidator(
				IJMSValidatorID.JMS_TOPIC_DESTINATION_NAME_NOT_EMPTY_001,
		...
		addAttributeValidator(new CapabilityAttributeUniqueInHostValidator(
				IJMSValidatorID.JMS_TOPIC_DESTINATION_NAME_UNIQUENESS_001,
				JmsPackage.Literals.JMS_DESTINATION__DESTINATION_NAME));

		addAttributeValidator(new DeployAttributeStringNotEmptyValidator(
				IJMSValidatorID.JMS_TOPIC_DESTINATION_JNDINAME_NOT_EMPTY_001,
				JmsPackage.Literals.JMS_DESTINATION__JNDI_NAME, IStatus.ERROR));

		addAttributeValidator(new CapabilityAttributeUniqueInHostValidator(
				IJMSValidatorID.JMS_TOPIC_DESTINATION_JNDINAME_UNIQUENESS_001,
