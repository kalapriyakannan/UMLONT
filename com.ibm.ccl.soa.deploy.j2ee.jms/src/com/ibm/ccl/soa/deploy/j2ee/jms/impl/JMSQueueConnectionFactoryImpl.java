...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>JMS Queue Connection Factory</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link com.ibm.ccl.soa.deploy.j2ee.jms.impl.JMSQueueConnectionFactoryImpl#getFactoryName <em>Factory Name</em>}</li>
 * <li>{@link com.ibm.ccl.soa.deploy.j2ee.jms.impl.JMSQueueConnectionFactoryImpl#getJndiName <em>Jndi Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class JMSQueueConnectionFactoryImpl extends CapabilityImpl implements
	 ...
	 * @generated
	 */
	protected JMSQueueConnectionFactoryImpl() {
		super();
	}
	...
	public void setFactoryName(String newFactoryName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					JmsPackage.JMS_QUEUE_CONNECTION_FACTORY__FACTORY_NAME, oldFactoryName, factoryName));
		}
	}
	...
	public void setJndiName(String newJndiName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					JmsPackage.JMS_QUEUE_CONNECTION_FACTORY__JNDI_NAME, oldJndiName, jndiName));
		}
	}
	...
	private final static List keys = Collections
			.singletonList(JmsPackage.Literals.JMS_QUEUE_CONNECTION_FACTORY__FACTORY_NAME);
