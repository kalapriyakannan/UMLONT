 ...
 * {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSActivationSpecificationUnit} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class JMSActivationSpecificationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSActivationSpecificationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSActivationSpecificationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSActivationSpecificationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSActivationSpecificationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSActivationSpecificationUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSActivationSpecificationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
