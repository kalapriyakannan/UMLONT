...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSTopicConnectionFactoryUnit} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class JMSTopicConnectionFactoryUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSTopicConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSTopicConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSTopicConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSTopicConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSTopicConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSTopicConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
