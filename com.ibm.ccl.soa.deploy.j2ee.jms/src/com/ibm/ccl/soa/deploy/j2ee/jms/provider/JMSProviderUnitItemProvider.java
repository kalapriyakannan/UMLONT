...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSProviderUnit} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class JMSProviderUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSProviderUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSProviderUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSProviderUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSProviderUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSProviderUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSProviderUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
