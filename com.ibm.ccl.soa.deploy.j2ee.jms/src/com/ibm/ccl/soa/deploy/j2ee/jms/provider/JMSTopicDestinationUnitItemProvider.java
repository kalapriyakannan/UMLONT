...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSTopicDestinationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JMSTopicDestinationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSTopicDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSTopicDestinationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSTopicDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSTopicDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSTopicDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSTopicDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
