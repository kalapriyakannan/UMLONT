...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSQueueDestinationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JMSQueueDestinationUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSQueueDestinationUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSQueueDestinationUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSQueueDestinationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSQueueDestinationUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSQueueDestinationUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSQueueDestinationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
