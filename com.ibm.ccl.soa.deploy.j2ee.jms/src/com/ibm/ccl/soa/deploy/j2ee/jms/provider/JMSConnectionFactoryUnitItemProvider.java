...
/**
 * This is the item provider adapter for a {@link com.ibm.ccl.soa.deploy.j2ee.jms.JMSConnectionFactoryUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JMSConnectionFactoryUnitItemProvider extends UnitItemProvider implements
	 ...
	 * @generated
	 */
	public JMSConnectionFactoryUnitItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JMSConnectionFactoryUnit.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JMSConnectionFactoryUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((JMSConnectionFactoryUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JMSConnectionFactoryUnit_type") : //$NON-NLS-1$
			getString("_UI_JMSConnectionFactoryUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
