 ...
 */
public class BusinessRulesManagerUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public BusinessRulesManagerUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("BusinessRulesManager"); //$NON-NLS-1$ 
	}
