 ...
 */
public class WPSCommonEventInfrastructureUnitEditPart extends UnitEditPart {
	/**
	 * @param view
	 */
	public WPSCommonEventInfrastructureUnitEditPart(View view) {
		super(view);
		// determine figure category description
		// TODO replace with translatable string
		setCategory("WPSCommonEventInfrastructure"); //$NON-NLS-1$ 
	}
